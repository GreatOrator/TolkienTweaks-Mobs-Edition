...
public class SpiderTreeStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SpiderTreeStructure() {
        super(CODEC, SpiderTreeStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SpiderTreeStructure.isFeatureChunk(context)) {
