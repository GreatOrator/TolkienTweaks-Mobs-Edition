...
public class TTMBranchesConfig {
    public static final Codec<TTMBranchesConfig> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
            ...
            ).apply(instance, TTMBranchesConfig::new)
    );
    ...
    public TTMBranchesConfig(int branchCount, int randomAddBranches, double length, double randomAddLength, double spacingYaw, double downwardsPitch) {
    ...
    public TTMBranchesConfig(int branchCount, double length) {
        this.branchCount = branchCount;
