...
public class HouseElvenStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public HouseElvenStructure() {
        super(CODEC, HouseElvenStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!HouseElvenStructure.isFeatureChunk(context)) {
