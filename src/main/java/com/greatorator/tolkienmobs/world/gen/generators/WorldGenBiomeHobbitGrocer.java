...
public class WorldGenBiomeHobbitGrocer extends WorldGenerator implements ITTMStructure, ITTMStructureSummon {
	...
	public boolean generate(World worldIn, Random r, BlockPos bp) {
		...
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 1, j + 4, k + 7), TTMFeatures.SIGNS.getStateFromMeta(13).withProperty(BlockSigns.FACING,EnumFacing.WEST).withProperty(BlockSigns.VARIANT, BlockSigns.EnumType.GROCER));
