...
//
//public class TTMSpiderTreeStructure extends Structure<NoFeatureConfig> {
//    public TTMSpiderTreeStructure(Codec<NoFeatureConfig> codec) {
//        super(codec);
//    }
//
//    @Override
//    public IStartFactory<NoFeatureConfig> getStartFactory() {
//        return TTMSpiderTreeStructure.Start::new;
//    }
//
//    @Override
...
//                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation(MODID, "ttmspidertree")), 10),
