...
public class WorldGenBiomeHobbitHouse extends WorldGenerator implements IWorldGenerator{
	...
	public boolean generate(World worldIn, Random r, BlockPos bp) {
		...
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 1, j + 4, k + 7), Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
		...
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 6, j + 2, k + 6), Blocks.CARPET.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW));
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 6, j + 2, k + 7), Blocks.AIR.getDefaultState());
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 6, j + 2, k + 8), Blocks.LIT_FURNACE.getDefaultState());
		...
		this.setBlockAndNotifyAdequately(worldIn, bp.add(i + 7, j + 6, k + 9), Blocks.BRICK_BLOCK.getDefaultState());
