...
public class DesertInnStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public DesertInnStructure() {
        super(CODEC, DesertInnStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!DesertInnStructure.isFeatureChunk(context)) {
