...
public class TreeFeature {
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MIRKWOOD = FeatureUtils.register((MODID + "mirkwood"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.MIRKWOOD));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MALLORN = FeatureUtils.register((MODID + "mallorn"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.MALLORN));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> CULUMALDA = FeatureUtils.register((MODID + "culumalda"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.CULUMALDA));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> CULUMALDA_FIRIEN = FeatureUtils.register((MODID + "culumalda_firien"), Feature.TREE,(TreeFeatureConfig.TreeConfigurations.CULUMALDA_FIRIEN));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> LEBETHRON = FeatureUtils.register((MODID + "lebethron"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.LEBETHRON));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> LEBETHRON_FIRIEN = FeatureUtils.register((MODID + "lebethron_firien"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.LEBETHRON_FIRIEN));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> DEADTREE = FeatureUtils.register((MODID + "deadtree"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.DEADTREE));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANGORNOAK = FeatureUtils.register((MODID + "fangornoak"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.FANGORNOAK));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> OLDFORESTOAK = FeatureUtils.register((MODID + "oldforestoak"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.OLDFORESTOAK));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MUSHROOM_BLOOM_DECAY = FeatureUtils.register((MODID + "bloomdecay"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.MUSHROOM_BLOOM_DECAY));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MUSHROOM_DECAY_BLOOM = FeatureUtils.register((MODID + "decaybloom"), Feature.TREE, (TreeFeatureConfig.TreeConfigurations.MUSHROOM_DECAY_BLOOM));
