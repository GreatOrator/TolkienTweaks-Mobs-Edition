...
public class HouseHumanStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public HouseHumanStructure() {
        super(CODEC, HouseHumanStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!HouseHumanStructure.isFeatureChunk(context)) {
