...
public class TTMFeatures {
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> LEBETHRON = register("lebethron", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TTMFeatures.States.LEBETHRON_LOG), new SimpleBlockStateProvider(TTMFeatures.States.LEBETHRON_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
