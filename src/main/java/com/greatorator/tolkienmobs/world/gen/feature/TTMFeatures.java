...
public class TTMFeatures {
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> DEADTREE = register("deadtree", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TTMFeatures.States.DEADWOOD_LOG), new SimpleBlockStateProvider(TTMFeatures.States.AIR), new FancyFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(4), 4), new FancyTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).setIgnoreVines().func_236702_a_(Heightmap.Type.MOTION_BLOCKING).build()));
