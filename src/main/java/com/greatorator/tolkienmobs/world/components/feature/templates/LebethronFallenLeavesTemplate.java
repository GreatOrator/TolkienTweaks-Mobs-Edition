...
public class LebethronFallenLeavesTemplate extends Feature<NoneFeatureConfiguration> {
    public LebethronFallenLeavesTemplate(Codec<NoneFeatureConfiguration> config) {
        super(config);
    }
