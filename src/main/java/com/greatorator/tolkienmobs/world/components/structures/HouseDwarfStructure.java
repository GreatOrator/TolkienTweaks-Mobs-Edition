...
public class HouseDwarfStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public HouseDwarfStructure() {
        super(CODEC, HouseDwarfStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!HouseDwarfStructure.isFeatureChunk(context)) {
