...
import com.greatorator.tolkienmobs.world.components.placements.BranchingLargeTrunkPlacement;
import com.greatorator.tolkienmobs.world.components.placements.BranchingTrunkPlacement;
import com.greatorator.tolkienmobs.world.components.placements.RootPlacements;
import com.greatorator.tolkienmobs.world.components.placements.SpheroidFoliagePlacement;
...
public class TreeFeatureConfig implements FeatureConfiguration {
    ...
    public static final RegistryObject<FoliagePlacerType<SpheroidFoliagePlacement>> FOLIAGE_SPHEROID = FOLIAGE_PLACER_REGISTER.register("spheroid_foliage_placer", () -> new FoliagePlacerType<>(SpheroidFoliagePlacement.CODEC));
    public static final RegistryObject<TrunkPlacerType<BranchingTrunkPlacement>> TRUNK_BRANCHING = TRUNK_PLACERS.register("branching_trunk_placer", () -> new TrunkPlacerType<>(BranchingTrunkPlacement.CODEC));
    public static final RegistryObject<TrunkPlacerType<BranchingLargeTrunkPlacement>> TRUNK_BRANCHING_LARGE = TRUNK_PLACERS.register("branching_large_trunk_placer", () -> new TrunkPlacerType<>(BranchingLargeTrunkPlacement.CODEC));
    ...
    public static final RegistryObject<TreeDecoratorType<RootPlacements>> TREE_ROOTS = TREE_DECORATORS.register("tree_roots", () -> new TreeDecoratorType<>(RootPlacements.CODEC));
