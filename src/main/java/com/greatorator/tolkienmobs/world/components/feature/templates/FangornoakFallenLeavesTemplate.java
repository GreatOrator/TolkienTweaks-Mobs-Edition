...
public class FangornoakFallenLeavesTemplate extends Feature<NoneFeatureConfiguration> {
    public FangornoakFallenLeavesTemplate(Codec<NoneFeatureConfiguration> config) {
        super(config);
    }
