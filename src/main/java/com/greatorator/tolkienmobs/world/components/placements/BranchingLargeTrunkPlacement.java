...
public class BranchingLargeTrunkPlacement extends TrunkPlacer {
    public static final Codec<BranchingLargeTrunkPlacement> CODEC = RecordCodecBuilder.create(instance ->
        ...
        )).apply(instance, BranchingLargeTrunkPlacement::new)
);
    ...
    public BranchingLargeTrunkPlacement(int baseHeight, int randomHeightA, int randomHeightB, int branchDownwardOffset, BranchesConfig branchesConfig, boolean perpendicularBranches) {
    ...
    @Override
    protected TrunkPlacerType<BranchingLargeTrunkPlacement> type() {
