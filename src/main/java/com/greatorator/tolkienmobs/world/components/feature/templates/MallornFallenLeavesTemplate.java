...
public class MallornFallenLeavesTemplate extends Feature<NoneFeatureConfiguration> {
    public MallornFallenLeavesTemplate(Codec<NoneFeatureConfiguration> config) {
        super(config);
    }
