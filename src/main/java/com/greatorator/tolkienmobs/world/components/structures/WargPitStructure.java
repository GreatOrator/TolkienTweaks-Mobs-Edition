...
public class WargPitStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public WargPitStructure() {
        super(CODEC, WargPitStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!WargPitStructure.isFeatureChunk(context)) {
