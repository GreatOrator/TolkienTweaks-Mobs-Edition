...
public class StoneSpikeTemplate extends Feature<NoneFeatureConfiguration> {
   public StoneSpikeTemplate(Codec<NoneFeatureConfiguration> configIn) {
      super(configIn);
   }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (!worldgenlevel.getBlockState(blockpos).is(Blocks.GRASS)) {
            return false;
        } else {
                ...
                for(int i1 = -l; i1 <= l; ++i1) {
                    ...
                    for(int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(random.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir() || isDirt(blockstate) || blockstate.is(Blocks.GRASS)) {
            ...
            for(int l1 = -k1; l1 <= k1; ++l1) {
                for(int i2 = -k1; i2 <= k1; ++i2) {
                    ...
                    while(blockpos1.getY() > 50) {
                        ...
                        if (!blockstate1.isAir() && !isDirt(blockstate1) && !blockstate1.is(Blocks.GRASS)) {
                            break;
                        }
