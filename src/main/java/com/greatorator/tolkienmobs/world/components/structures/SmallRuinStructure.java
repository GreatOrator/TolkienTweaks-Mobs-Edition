...
public class SmallRuinStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SmallRuinStructure() {
        super(CODEC, SmallRuinStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SmallRuinStructure.isFeatureChunk(context)) {
