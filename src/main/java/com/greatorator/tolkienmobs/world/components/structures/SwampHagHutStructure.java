...
public class SwampHagHutStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SwampHagHutStructure() {
        super(CODEC, SwampHagHutStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SwampHagHutStructure.isFeatureChunk(context)) {
