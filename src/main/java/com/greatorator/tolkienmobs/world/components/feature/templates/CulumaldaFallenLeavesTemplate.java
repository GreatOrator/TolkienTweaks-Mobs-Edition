...
public class CulumaldaFallenLeavesTemplate extends Feature<NoneFeatureConfiguration> {
    public CulumaldaFallenLeavesTemplate(Codec<NoneFeatureConfiguration> config) {
        super(config);
    }
