...
public class SpheroidFoliagePlacement extends FoliagePlacer {
    public static final Codec<SpheroidFoliagePlacement> CODEC = RecordCodecBuilder.create(
            ...
            ).apply(instance, SpheroidFoliagePlacement::new)
    );
    ...
    public SpheroidFoliagePlacement(float horizontalRadius, float verticalRadius, IntProvider yOffset, int randomHorizontal, int randomVertical, float verticalBias, int shag_factor) {
    ...
    @Override
    protected FoliagePlacerType<SpheroidFoliagePlacement> type() {
