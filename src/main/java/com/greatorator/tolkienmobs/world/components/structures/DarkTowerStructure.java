...
public class DarkTowerStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public DarkTowerStructure() {
        super(CODEC, DarkTowerStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!DarkTowerStructure.isFeatureChunk(context)) {
