...
public class BarrowStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public BarrowStructure() {
        super(CODEC, BarrowStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!BarrowStructure.isFeatureChunk(context)) {
