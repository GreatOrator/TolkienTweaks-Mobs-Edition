...
public class HouseHobbitStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public HouseHobbitStructure() {
        super(CODEC, HouseHobbitStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!HouseHobbitStructure.isFeatureChunk(context)) {
