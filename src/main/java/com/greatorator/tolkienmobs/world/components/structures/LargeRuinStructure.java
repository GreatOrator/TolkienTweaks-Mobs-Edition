...
public class LargeRuinStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public LargeRuinStructure() {
        super(CODEC, LargeRuinStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!LargeRuinStructure.isFeatureChunk(context)) {
