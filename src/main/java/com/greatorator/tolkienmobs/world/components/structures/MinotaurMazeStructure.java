...
public class MinotaurMazeStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MinotaurMazeStructure() {
        super(CODEC, MinotaurMazeStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MinotaurMazeStructure.isFeatureChunk(context)) {
