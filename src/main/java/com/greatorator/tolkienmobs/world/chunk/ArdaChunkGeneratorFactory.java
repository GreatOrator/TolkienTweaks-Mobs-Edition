package com.greatorator.tolkienmobs.world.chunk;
...
//
//public class ArdaChunkGeneratorFactory extends NoiseChunkGenerator {
//
...
//
//    public static final Codec<ArdaChunkGeneratorFactory> CODEC = RecordCodecBuilder.create(instance ->
//            instance.group(
//                    RegistryLookupCodec.create(Registry.BIOME_REGISTRY).forGetter(ArdaChunkGeneratorFactory::getBiomeRegistry),
//                    SETTINGS_CODEC.fieldOf("settings").forGetter(ArdaChunkGeneratorFactory::getTutorialSettings)
//            ).apply(instance, ArdaChunkGeneratorFactory::new));
//
//    private final Settings settings;
//
//    public ArdaChunkGeneratorFactory(Registry<Biome> registry, Settings settings) {
//        super(new TTMBiomeProvider(registry), new DimensionStructuresSettings(false));
//        this.settings = settings;
//        LOGGER.info("Chunk generator settings: " + settings.getBaseHeight() + ", " + settings.getHorizontalVariance() + ", " + settings.getVerticalVariance());
//    }
//
...
//        return ((TTMBiomeProvider)biomeSource).getBiomeRegistry();
//    }
//
//    @Override
...
//        return new ArdaChunkGeneratorFactory(getBiomeRegistry(), settings);
//    }
//
//    @Override
