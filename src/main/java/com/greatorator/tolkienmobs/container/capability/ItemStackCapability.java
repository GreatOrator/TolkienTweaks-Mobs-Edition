 ...
 */
public class ItemStackCapability implements IItemHandlerModifiable, ICapabilityProvider {
    ...
    public ItemStackCapability(ItemStack stack, int slots) {
        this.stack = stack;
        this.slots = slots;
    }

    public ItemStackCapability setStackValidator(BiPredicate<Integer, ItemStack> stackValidator) {
        this.stackValidator = stackValidator;
        return this;
    }

    public ItemStackCapability setStackValidator(Predicate<ItemStack> stackValidator) {
