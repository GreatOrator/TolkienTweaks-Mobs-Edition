...
public class CoinPouchContainer extends ContainerBCore<CoinPouchItem> {
    ...
    public CoinPouchContainer(int windowId, Inventory playerInv, FriendlyByteBuf extraData) {
        super(TolkienContainers.COIN_POUCH_CONTAINER, windowId, playerInv, extraData);
        this.slot = PlayerSlot.fromBuff(extraData);
        onContainerOpen();
    }

    public CoinPouchContainer(@Nullable MenuType type, int windowId, Inventory player, PlayerSlot slot) {
    ...
    public static class Provider implements MenuProvider {
        ...
        public Component getDisplayName() {
            return stack.getHoverName().plainCopy().append(" ").append(new TranslatableComponent("gui.tolkienmobs.coin_pouch.title"));
        }
        @Nullable
        @Override
        public AbstractContainerMenu createMenu(int menuID, Inventory playerInventory, Player playerEntity) {
            return new CoinPouchContainer(TolkienContainers.COIN_POUCH_CONTAINER, menuID, playerInventory, slot);
        }
