...
public class LockableTreasureChestContainer extends ContainerBCTile<LockableTreasureChestTile> {
    ...
    public LockableTreasureChestContainer(int windowId, Inventory playerInv, FriendlyByteBuf extraData) {
        this(TolkienContainers.LOCKABLE_TREASURE_CHEST_CONTAINER, windowId, playerInv, getClientTile(playerInv, extraData));
        //^^ Don't forget this!
    }

    public LockableTreasureChestContainer(@Nullable MenuType<?> type, int windowId, Inventory playerInv, LockableTreasureChestTile tile) {
