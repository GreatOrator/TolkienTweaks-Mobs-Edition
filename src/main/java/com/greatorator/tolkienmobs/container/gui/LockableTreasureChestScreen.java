...
import com.greatorator.tolkienmobs.container.LockableTreasureChestContainer;
...
public class LockableTreasureChestScreen extends ModularGuiContainer<LockableTreasureChestContainer> {
    protected GuiToolkit<LockableTreasureChestScreen> toolkit = new GuiToolkit<>(this, 171, 166).setTranslationPrefix("gui.tolkienmobs.lockable_treasure_chest");
    private static final Pattern invalidCharacters = Pattern.compile("[^a-zA-Z-_\\d:]");
    private LockableTreasureChestTile tile;
    private final PlayerEntity player;

    public LockableTreasureChestScreen(LockableTreasureChestContainer container, PlayerInventory inv, ITextComponent titleIn) {
