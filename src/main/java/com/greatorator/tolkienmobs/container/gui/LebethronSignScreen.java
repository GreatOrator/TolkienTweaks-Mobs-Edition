...
import com.greatorator.tolkienmobs.entity.tile.render.RenderLebethronSignTile;
 ...
 */
public class LebethronSignScreen extends Screen {
    private final RenderLebethronSignTile.SignModel signModel = new RenderLebethronSignTile.SignModel();
    private final LebethronSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public LebethronSignScreen(LebethronSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderLebethronSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
