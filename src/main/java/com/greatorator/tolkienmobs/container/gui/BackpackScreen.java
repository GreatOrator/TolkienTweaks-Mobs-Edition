...
//        toolkit.placeOutside(offhandSlot, armorSlots.playerSlots, GuiToolkit.LayoutPos.BOTTOM_CENTER, 0, 0);
        ...
        // ### Crafting Slots ###
        GuiTexture craftTexture = template.background.addChild(new GuiTexture(imageWidth, imageHeight, 56, 56, SpriteRegister.get("backpack/crafting_table")));
        ...
        GuiTexture craftArrow = template.background.addChild(new GuiTexture(16, 16, SpriteRegister.get("backpack/craft_arrow")));
        toolkit.placeOutside(craftArrow, craftOutputSlot, GuiToolkit.LayoutPos.MIDDLE_RIGHT, 4, -1);

        // ### Tank ###
        GuiTexture tankSlotsTex = template.background.addChild(new GuiTexture(20, 75, SpriteRegister.get("backpack/tank_slots")));
        ...
        GuiTexture tankArrows = template.background.addChild(new GuiTexture(12, 12, SpriteRegister.get("backpack/tank_arrows")));
        toolkit.placeOutside(tankArrows, tankSlotsTex, GuiToolkit.LayoutPos.MIDDLE_RIGHT, 1, 0);

        GuiTexture tankBG = template.background.addChild(new GuiTexture(12, 75, SpriteRegister.get("backpack/tank")));
        ...
        GuiTexture tankOverlay = fluidRenderer.addChild(new GuiTexture(12, 75, SpriteRegister.get("backpack/tank_overlay")));
        toolkit.placeOutside(tankOverlay, tankArrows, GuiToolkit.LayoutPos.MIDDLE_RIGHT, 1, 0);

        GuiButton bedButton = toolkit.createIconButton(template.background, 16, 16, () -> tile.isSleepingbagDeployed.get() ? SpriteRegister.get("backpack/bed_deployed") : SpriteRegister.get("backpack/bed"));
        ...
        GuiButton campfireButton = toolkit.createIconButton(template.background, 16, 16, () -> tile.isCampfireDeployed.get() ? SpriteRegister.get("backpack/campfire_deployed") : SpriteRegister.get("backpack/campfire"));
        ...
        GuiButton upgradeButton = toolkit.createIconButton(template.background, 16, 16, () -> displayUpgrades ? SpriteRegister.get("backpack/close_upgrade") : SpriteRegister.get("backpack/upgrade"));
