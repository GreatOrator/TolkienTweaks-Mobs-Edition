...
public class FireplaceScreen extends ModularGuiContainer<ContainerBCTile<FireplaceTile>> {
    ...
    public void addElements(GuiElementManager manager) {
        ...
        GuiProgressIcon fireIcon = template.background.addChild(new GuiProgressIcon(SpriteRegister.get("fireplace/fire_empty"), SpriteRegister.get("fireplace/fire_full"), UP));//.setMargins(0, 1).setProgressSupplier(() -> (TimeKeeper.getClientTick() % 100) / 100D).setPos(20, 0).setSize(18, 18));
        ...
        GuiProgressIcon progressIcon = template.background.addChild(new GuiProgressIcon(SpriteRegister.get("fireplace/craft_empty"), SpriteRegister.get("fireplace/craft_full"), RIGHT));//.setMargins(0, 1).setProgressSupplier(() -> (TimeKeeper.getClientTick() % 100) / 100D).setPos(20, 0).setSize(18, 18));
