...
public class CamoFluidContainer extends ContainerBCTile<CamoFluidTile> {
    ...
    public CamoFluidContainer(int windowId, PlayerInventory playerInv, PacketBuffer extraData) {
        this(TTMContent.CAMO_FLUID_CONTAINER, windowId, playerInv, getClientTile(extraData));
        //^^ Don't forget this!
    }

    public CamoFluidContainer(@Nullable ContainerType<?> type, int windowId, PlayerInventory playerInv, CamoFluidTile tile) {
