...
public class EntityTTMCrebain extends ParrotEntity {
    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(EntityTTMCrebain.class, DataSerializers.INT);
    private static final Item DEADLY_ITEM = Items.COOKIE;
    private static final Set<Item> TAME_ITEMS = Sets.newHashSet(Items.ROTTEN_FLESH, TTMContent.MONSTER_FLESH.get());
    ...
    public EntityTTMCrebain(EntityType<? extends EntityTTMCrebain> type, World worldIn) {
        super(type, worldIn);
    ...
    public static SoundEvent getAmbient(World p_234212_0_, Random p_234212_1_) {
        return SoundGenerator.soundCallCrebain.get();
    }

    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SoundGenerator.soundHurtCrebain.get();
    }

    protected SoundEvent getDeathSound() {
        return SoundGenerator.soundDeathCrebain.get();
    }
    ...
    public static boolean checkCrebainSpawn(EntityType<EntityTTMCrebain> type, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
