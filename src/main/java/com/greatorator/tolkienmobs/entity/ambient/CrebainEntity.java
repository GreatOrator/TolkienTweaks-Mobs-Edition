...
//
//public class CrebainEntity extends ParrotEntity {
//    private static final DataParameter<Integer> VARIANT = EntityDataManager.defineId(CrebainEntity.class, DataSerializers.INT);
//    private static final Item DEADLY_ITEM = Items.COOKIE;
//    private static final Set<Item> TAME_ITEMS = Sets.newHashSet(Items.ROTTEN_FLESH, TolkienContent.MONSTER_FLESH.get());
//
//    public float flap;
...
//
//    public CrebainEntity(EntityType<? extends CrebainEntity> type, World worldIn) {
//        super(type, worldIn);
...
//    }
//
//    public static boolean checkCrebainSpawn(EntityType<CrebainEntity> type, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
