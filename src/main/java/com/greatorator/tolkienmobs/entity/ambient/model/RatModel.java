...
@OnlyIn(Dist.CLIENT)
public class RatModel<E extends AnimalEntity> extends EntityModel<RatEntity> {
    ...
    @Override
    public void setupAnim(RatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
