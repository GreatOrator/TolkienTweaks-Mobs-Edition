...
public class SwarmRender<T extends MobEntity, M extends EntityModel<T>> extends MobRenderer<T, M> {
    private final ResourceLocation SWARM_TEXTURE;

    public SwarmRender(EntityRendererManager manager, M model, float shadowSize, String textureName) {
