...
public class ModelTTMThrush extends SegmentedModel<EntityTTMThrush> {
    ...
    @Override
    public void setupAnim(EntityTTMThrush p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
    ...
    public void renderOnShoulder(MatrixStack p_228284_1_, IVertexBuilder p_228284_2_, int p_228284_3_, int p_228284_4_, float p_228284_5_, float p_228284_6_, float p_228284_7_, float p_228284_8_, int p_228284_9_) {
        this.prepare(ModelTTMThrush.State.ON_SHOULDER);
        this.setupAnim(ModelTTMThrush.State.ON_SHOULDER, p_228284_9_, p_228284_5_, p_228284_6_, 0.0F, p_228284_7_, p_228284_8_);
        this.parts().forEach((p_228285_4_) -> {
            p_228285_4_.render(p_228284_1_, p_228284_2_, p_228284_3_, p_228284_4_);
        });
    }

    private void setupAnim(ModelTTMThrush.State p_217162_1_, int p_217162_2_, float p_217162_3_, float p_217162_4_, float p_217162_5_, float p_217162_6_, float p_217162_7_) {
    ...
    private void prepare(ModelTTMThrush.State p_217160_1_) {
    ...
    private static ModelTTMThrush.State getState(EntityTTMThrush p_217158_0_) {
