...
public class ModelTTMThrush extends SegmentedModel<EntityTTMThrush> {
    ...
    public ModelTTMThrush() {
        ...
        this.ThrushHead.setRotationPoint(0.5F, 19.2F, -2.5F);
        this.ThrushHead.addBox(-1.0F, -1.5F, -2.5F, 2, 2, 3, 0.0F);
        this.ThrushWingR1 = new ModelRenderer(this, 0, 9);
        this.ThrushWingR1.setRotationPoint(-1.0F, 20.0F, 0.0F);
        ...
        this.ThrushLegR1.setRotationPoint(-0.3F, 21.3F, 0.0F);
        ...
        this.ThrushTail1.setRotationPoint(0.0F, 21.4F, 4.3F);
        ...
        this.ThrushLegL1.setRotationPoint(1.3F, 21.3F, 0.0F);
        ...
        this.ThrushWingL1.setRotationPoint(0.5F, 21.5F, 1.3F);
