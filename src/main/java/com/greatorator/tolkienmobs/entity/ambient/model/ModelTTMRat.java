...
public class ModelTTMRat<E extends AnimalEntity> extends EntityModel<EntityTTMRat> {
    ...
    public ModelTTMRat() {
        ...
        this.RatEarR.setRotationPoint(-0.7F, -0.7F, -1.0F);
        this.RatEarR.addBox(-2.0F, -2.0F, -0.5F, 2, 2, 1, 0.0F);
        this.RatWhiskers_2 = new ModelRenderer(this, 20, 24);
        this.RatWhiskers_2.setRotationPoint(1.5F, -0.7F, 0.0F);
    ...
    public void setRotationAngles(EntityTTMRat entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.RatLegFL.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        this.RatLegFR.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;

        this.RatLegRR.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        this.RatLegRL.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;

        this.RatHead.rotateAngleY = netHeadYaw * 0.017453292F;
        this.RatHead.rotateAngleX = headPitch * 0.017453292F;
