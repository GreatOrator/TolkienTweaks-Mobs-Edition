 ...
 */
public class SquirrelModel<E extends AnimalEntity> extends EntityModel<SquirrelEntity> {
    ...
    @Override
    public void setupAnim(SquirrelEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public void prepareMobModel(SquirrelEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
