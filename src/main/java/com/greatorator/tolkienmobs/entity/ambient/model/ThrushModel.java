...
/* Thrush - GreatOrator */
//
//public class ThrushModel extends SegmentedModel<ThrushEntity> {
...
//
//    @Override
//    public void setupAnim(ThrushEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
//        this.setupAnim(getState(p_225597_1_), p_225597_1_.tickCount, p_225597_2_, p_225597_3_, p_225597_4_, p_225597_5_, p_225597_6_);
//    }
//
//    @Override
//    public void prepareMobModel(ThrushEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
...
//        this.prepare(ThrushModel.State.ON_SHOULDER);
//        this.setupAnim(ThrushModel.State.ON_SHOULDER, p_228284_9_, p_228284_5_, p_228284_6_, 0.0F, p_228284_7_, p_228284_8_);
//        this.parts().forEach((p_228285_4_) -> {
//            p_228285_4_.render(p_228284_1_, p_228284_2_, p_228284_3_, p_228284_4_);
//        });
//    }
//
//    private void setupAnim(ThrushModel.State p_217162_1_, int p_217162_2_, float p_217162_3_, float p_217162_4_, float p_217162_5_, float p_217162_6_, float p_217162_7_) {
...
//    }
//
//    private void prepare(ThrushModel.State p_217160_1_) {
...
//    }
//
//    private static ThrushModel.State getState(ThrushEntity p_217158_0_) {
//        if (p_217158_0_.isPartyParrot()) {
//            return ThrushModel.State.PARTY;
//        } else if (p_217158_0_.isInSittingPose()) {
//            return ThrushModel.State.SITTING;
//        } else {
//            return p_217158_0_.isFlying() ? ThrushModel.State.FLYING : ThrushModel.State.STANDING;
//        }
//    }
//
//    @OnlyIn(Dist.CLIENT)
