...
public class SwarmEntity extends MonsterEntity {
    public SwarmEntity(EntityType<? extends SwarmEntity> type, World world) {
        super(type, world);
    ...
    public static boolean checkSwarmSpawn(EntityType<SwarmEntity> type, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
