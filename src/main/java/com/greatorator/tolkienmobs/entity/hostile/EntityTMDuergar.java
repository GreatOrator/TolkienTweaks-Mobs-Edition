...
public class EntityTMDuergar extends EntityTMHostiles {
    ...
    public boolean getCanSpawnHere() {
        ...
        if (this.world.getDifficulty() != EnumDifficulty.PEACEFUL && this.isValidLightLevel() && super.getCanSpawnHere() && !this.world.canSeeSky(new BlockPos(this)) && this.posY < 74.0D) {
            if (willSpawn <= 10) {
                monsterSpawn = true;
            }
        }
