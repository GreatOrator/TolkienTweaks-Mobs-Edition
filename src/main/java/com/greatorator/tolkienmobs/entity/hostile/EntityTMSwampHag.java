...
//
//public class EntityTMSwampHag extends EntityTMHostiles implements IRangedAttackMob
//{
...
//    private static final DataParameter<Boolean> IS_DRINKING = EntityDataManager.<Boolean>createKey(EntityTMSwampHag.class, DataSerializers.BOOLEAN);
//    /**
...
//
//    public EntityTMSwampHag(World worldIn)
//    {
//        super(worldIn);
//        this.setSize(0.6F, 1.95F);
//        this.setRndMinMax(1,5);
//        this.setLootTable(LootInit.SWAMPHAG);
//    }
//
//    public static void registerFixesTMSwampHag(DataFixer fixer)
//    {
//        EntityLiving.registerFixesMob(fixer, EntityTMSwampHag.class);
//    }
//
