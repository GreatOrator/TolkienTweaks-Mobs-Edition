...
//import com.greatorator.tolkienmobs.world.world_old.biomes.BiomeHaradwaith;
...
//        this.tasks.addTask(4, new EntityTMToad.AIAvoidEntity(this, PlayerEntity.class, 8.0F, 2.2D, 2.2D));
...
//        this.tasks.addTask(11, new EntityAIWatchClosest(this, PlayerEntity.class, 10.0F));
//    }
//
