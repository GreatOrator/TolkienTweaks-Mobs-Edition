...
//        {
//            BlockPos blockpos = new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ);
//
...
//                {
//                    worldIn.playEvent(3001, new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ), 0);
//                }
//            }
//            else
//            {
...
//                        worldgenspikes.setBeamTarget(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ));
...
//                {
//                    entityendercrystal1.setBeamTarget(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ));
//                }
//            }
//            else if (ticks < 5)
//            {
...
//    };
//
//    private FellBeastSpawnManager()
//    {
//    }
//
//    public abstract void process(WorldServer worldIn, FellBeastFightManager manager, List<EntityEnderCrystal> crystals, int ticks, BlockPos pos);
//}