...
//        {
//            this.targetLocation = new Vec3d(this.fellbeast.world.getTopSolidOrLiquidBlock(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ)));
//        }
//
