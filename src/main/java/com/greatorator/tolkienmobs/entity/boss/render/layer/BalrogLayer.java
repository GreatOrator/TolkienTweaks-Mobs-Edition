...
public abstract class BalrogLayer<T extends LivingEntity & IAnimatable> extends GeoEntityRenderer<T> {
    protected T tolkienEntity;
    protected RenderType renderType;
    protected abstract ItemStack getHeldItemStack();
    protected abstract String getArmPartName();

    public BalrogLayer(EntityRendererProvider.Context context, AnimatedGeoModel<T> modelProvider) {
