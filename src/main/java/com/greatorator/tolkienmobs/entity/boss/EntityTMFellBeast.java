...
//import com.greatorator.tolkienmobs.entity.entityai.phase.TTMPhaseManager;
...
//    /** An array containing all body parts of this fellbeast */
//    public MultiPartEntityPart[] fellbeastPartArray;
//    /** The head bounding box of a fellbeast */
...
//    /** The body bounding box of a fellbeast */
...
//    /** Activated if the fellbeast is flying though obsidian, white stone or bedrock. Slows movement and animation speed. */
//    public boolean slowed;
//    public int deathTicks;
//    /** The current endercrystal that is healing this fellbeast */
//    public EntityEnderCrystal healingEnderCrystal;
//    /** The fellbeast fight manager */
//    private final FellBeastFightManager fellbeastFightManager;
//    /** The fellbeast phase manager */
//    private final TTMPhaseManager ttmphaseManager;
//    private int growlTime = 200;
//    private int sittingDamageReceived;
//    public boolean fellbeastJockey;
//    /**
...
//        else
//        {
//            this.fellbeastFightManager = null;
//        }
//
//        this.ttmphaseManager = new TTMPhaseManager(this);
//    }
//
//    @Nullable
...
//    {
//        super.entityInit();
//        this.getDataManager().register(PHASE, Integer.valueOf(TTMPhaseList.HOVER.getId()));
//    }
//
...
//                }
//
//                if (!this.ttmphaseManager.getCurrentPhase().getIsStationary() && --this.growlTime < 0)
//                {
...
//
//            if (this.ttmphaseManager.getCurrentPhase().getIsStationary())
//            {
//                this.animTime += 0.1F;
//            }
//            else if (this.slowed)
...
//                    }
//
//                    this.ttmphaseManager.getCurrentPhase().doClientRenderEffects();
//                }
//                else
//                {
//                    ITTMPhase iphase = this.ttmphaseManager.getCurrentPhase();
//                    iphase.doLocalUpdate();
//
//                    if (this.ttmphaseManager.getCurrentPhase() != iphase)
//                    {
//                        iphase = this.ttmphaseManager.getCurrentPhase();
//                        iphase.doLocalUpdate();
//                    }
//
...
//                if (!this.world.isRemote)
//                {
//                    this.slowed = this.destroyBlocksInAABB(this.fellbeastPartHead.getEntityBoundingBox()) | this.destroyBlocksInAABB(this.fellbeastPartNeck.getEntityBoundingBox()) | this.destroyBlocksInAABB(this.fellbeastPartBody.getEntityBoundingBox());
//
...
//
//    /**
//     * Updates the state of the enderfellbeast's current endercrystal.
//     */
...
//
//    /**
//     * Pushes all entities inside the list away from the enderfellbeast.
//     */
...
//
//                if (!this.ttmphaseManager.getCurrentPhase().getIsStationary() && ((LivingEntity)entity).getRevengeTimer() < entity.ticksExisted - 2)
//                {
...
//    {
//        damage = this.ttmphaseManager.getCurrentPhase().getAdjustedDamage(fellbeastPart, source, damage);
//
...
//
//                if (this.getHealth() <= 0.0F && !this.ttmphaseManager.getCurrentPhase().getIsStationary())
//                {
//                    this.setHealth(1.0F);
//                    this.ttmphaseManager.setPhase(TTMPhaseList.DYING);
//                }
//
//                if (this.ttmphaseManager.getCurrentPhase().getIsStationary())
//                {
...
//                        this.ttmphaseManager.setPhase(TTMPhaseList.TAKEOFF);
//                    }
//                }
//            }
//
...
//        {
//            this.attackEntityFromPart(this.fellbeastPartBody, source, amount);
//        }
//
//        return false;
//    }
//
//    /**
//     * Provides a way to cause damage to an ender fellbeast.
//     */
...
//        int i = 500;
//
//        if (this.fellbeastFightManager != null && !this.fellbeastFightManager.hasPreviouslyKilledFellBeast())
//        {
//            i = 12000;
//        }
//
...
//        int j = 0;
//
//        if (this.fellbeastFightManager == null || this.fellbeastFightManager.getNumAliveCrystals() == 0)
//        {
//            j = 12;
//        }
//
...
//        else
//        {
//            LogHelperTTM.info("Failed to find path from {} to {}", Integer.valueOf(startIdx), Integer.valueOf(finishIdx));
//
//            if (andThen != null)
//            {
...
//
//    /**
//     * Return the Entity parts making up this Entity (currently only for fellbeasts)
//     */
...
//    {
//        ITTMPhase iphase = this.ttmphaseManager.getCurrentPhase();
//        TTMPhaseList <? extends ITTMPhase > phaselist = iphase.getType();
//        double d0;
//
//        if (phaselist != TTMPhaseList.LANDING && phaselist != TTMPhaseList.TAKEOFF)
//        {
...
//        {
//            entityplayer = (PlayerEntity)dmgSrc.getTrueSource();
//        }
//        else
//        {
...
//        {
//            this.attackEntityFromPart(this.fellbeastPartHead, DamageSource.causeExplosionDamage(entityplayer), 10.0F);
//        }
//
//        this.ttmphaseManager.getCurrentPhase().onCrystalDestroyed(crystal, pos, dmgSrc, entityplayer);
//    }
//
...
//        {
//            this.ttmphaseManager.setPhase(TTMPhaseList.getById(((Integer)this.getDataManager().get(PHASE)).intValue()));
//        }
//
//        super.notifyDataManagerChange(key);
//    }
//
//    public TTMPhaseManager getFellBeastPhaseManager()
//    {
//        return this.ttmphaseManager;
//    }
//
