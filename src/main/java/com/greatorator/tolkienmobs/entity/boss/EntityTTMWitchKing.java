...
public class EntityTTMWitchKing extends MonsterEntity {
    ...
    private final MeleeAttackGoal meleeGoal = new MeleeAttackGoal(this, 1.2D, false) {
        ...
        public void stop() {
            super.stop();
            EntityTTMWitchKing.this.setAggressive(false);
        }

        @Override
        public void start() {
            super.start();
            EntityTTMWitchKing.this.setAggressive(true);
        }
    };
    /**
     * End Region
    ...
    public EntityTTMWitchKing(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static boolean checkWitchKingSpawn(EntityType<EntityTTMWitchKing> type, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
