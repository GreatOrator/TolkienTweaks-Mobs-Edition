...
public class EntityTTMMorgulIronGolem extends EntityTTMElementalGolem {
    private final ServerBossInfo bossInfo = (ServerBossInfo) (new ServerBossInfo(this.getDisplayName(), BossInfo.Color.PURPLE, BossInfo.Overlay.NOTCHED_10)).setDarkenScreen(true);
    ...
    public EntityTTMMorgulIronGolem(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
