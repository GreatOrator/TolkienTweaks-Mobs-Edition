...
//        this.setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(TolkienContent.SWORD_WITCHKING.get()));
//    }
//
//    @Override
...
//            ItemStack itemstack = this.getItemInHand(ProjectileHelper.getWeaponHoldingHand(this, TolkienContent.SWORD_WITCHKING.get()));
//            if (itemstack.getItem() == TolkienContent.SWORD_WITCHKING.get()) {
