...
import com.greatorator.tolkienmobs.entity.boss.fellbeast.phase.FellBeastPhaseType;
import com.greatorator.tolkienmobs.entity.boss.fellbeast.phase.IFellBeastPhase;
...
public class FellBeastEntity extends MobEntity implements IMob {
    ...
    public FellBeastEntity(EntityType<? extends FellBeastEntity> p_i50230_1_, World world) {
        ...
        if (world instanceof ServerWorld) {
            this.fellbeastFight = ((TTMServerWorld)world).fellbeastFight();
        } else {
