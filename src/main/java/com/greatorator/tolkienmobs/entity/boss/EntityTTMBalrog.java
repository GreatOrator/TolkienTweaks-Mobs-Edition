...
public class EntityTTMBalrog extends EntityTTMMonsters {
    ...
    private final MeleeAttackGoal meleeGoal = new EntityTTMBalrog.BalrogAttackGoal(this, 1.0D, 20, 15.0F, false);
    ...
    static class BalrogAttackGoal extends TTMThrowandAttack {
        private final EntityTTMBalrog balrog;
        private int raiseArmTicks;
        private int attackStep;
        private int attackTime;

        BalrogAttackGoal(EntityTTMBalrog balrogEntity, double speedAmplifier, int attackInterval, float maxDistance, boolean useLongMemory) {
