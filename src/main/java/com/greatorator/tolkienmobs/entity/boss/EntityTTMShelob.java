...
public class EntityTTMShelob extends MonsterEntity {
    ...
    private static final DataParameter<Byte> DATA_FLAGS_ID = EntityDataManager.defineId(EntityTTMShelob.class, DataSerializers.BYTE);
    private long nextAbilityUse = 0L;
    private final static long coolDown = 15000L;

    public EntityTTMShelob(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new EntityTTMShelob.AttackGoal(this));
        this.goalSelector.addGoal(5, new WaterAvoidingRandomWalkingGoal(this, 0.8D));
        this.goalSelector.addGoal(6, new LookAtGoal(this, PlayerEntity.class, 8.0F));
        this.goalSelector.addGoal(6, new LookRandomlyGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this));
        this.targetSelector.addGoal(2, new EntityTTMShelob.TargetGoal<>(this, PlayerEntity.class));
        this.targetSelector.addGoal(3, new EntityTTMShelob.TargetGoal<>(this, IronGolemEntity.class));
    }
    ...
    static class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(EntityTTMShelob p_i46676_1_) {
    ...
    static class TargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
        public TargetGoal(EntityTTMShelob p_i45818_1_, Class<T> p_i45818_2_) {
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
        ...
        if (spawnDataIn == null) {
            spawnDataIn = new EntityTTMShelob.GroupData();
            if (worldIn.getDifficulty() == Difficulty.HARD && worldIn.getRandom().nextFloat() < 0.1F * difficultyIn.getSpecialMultiplier()) {
                ((EntityTTMShelob.GroupData)spawnDataIn).setRandomEffect(worldIn.getRandom());
            }
        }

        if (spawnDataIn instanceof EntityTTMShelob.GroupData) {
            Effect effect = ((EntityTTMShelob.GroupData)spawnDataIn).effect;
            if (effect != null) {
