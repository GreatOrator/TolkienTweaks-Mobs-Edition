...
public class EntityTTMWatcher extends WaterMobEntity {
    ...
    public EntityTTMWatcher(EntityType<? extends WaterMobEntity> type, World worldIn) {
        super(type, worldIn);
        this.moveControl = new EntityTTMWatcher.MoveHelperController(this);

    }

    @Override
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new EntityTTMWatcher.MoveRandomGoal(this));
        this.goalSelector.addGoal(1, new EntityTTMWatcher.WanderGoal(this, 1.0D, 100));
        this.goalSelector.addGoal(4, new RandomSwimmingGoal(this, 1.0D, 10));
        this.goalSelector.addGoal(4, new EntityTTMWatcher.AttackGoal(this));
    ...
    static class MoveHelperController extends MovementController {
        private final EntityTTMWatcher watcher;

        public MoveHelperController(EntityTTMWatcher p_i48945_1_) {
            super(p_i48945_1_);
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(EntityTTMWatcher entityTTMWatcher, double p_i48813_2_, int p_i48813_4_) {
    ...
    class MoveRandomGoal extends Goal {
        ...
        public MoveRandomGoal(EntityTTMWatcher entityTTMWatcher) {
            this.watcher = entityTTMWatcher;
        }
    ...
    static class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(EntityTTMWatcher entityTMWatcher) {
