 ...
 * Goat - GreatOrator
 */
public class GoatModel<T extends AbstractHorseEntity> extends AgeableModel<GoatEntity> {
    ...
    @Override
    public void setupAnim(GoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
