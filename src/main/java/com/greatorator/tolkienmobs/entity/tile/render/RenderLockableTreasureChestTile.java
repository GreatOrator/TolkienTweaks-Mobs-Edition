...
public class RenderLockableTreasureChestTile implements BlockEntityRenderer<LockableTreasureChestTile> {
    public RenderLockableTreasureChestTile(BlockEntityRendererProvider.Context context) {
