...
public class TTMMithrilBarrelTile extends TileBCore implements ITickableTileEntity, INamedContainerProvider, IRSSwitchable {
   public static final ContainerSlotLayout.LayoutFactory<TTMMithrilBarrelTile> SLOT_LAYOUT = (player, tile) -> new ContainerSlotLayout().playerMain(player).allTile(tile.itemHandler);
