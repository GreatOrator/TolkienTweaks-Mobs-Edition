...
public class LockableChestTile extends TileBCore implements MenuProvider, IInteractTile, IAnimatable {
    ...
    public LockableChestTile(BlockPos pos, BlockState state) {
        super(TolkienTiles.LOCKABLE_CHEST_TILE.get(), pos, state);
    ...
    public AbstractContainerMenu createMenu(int windowID, Inventory playerInventory, Player playerEntity) {
        return new ContainerBCTile<>(TolkienContainers.LOCKABLE_CHEST_CONTAINER, windowID, playerInventory, this, SLOT_LAYOUT);
    }
