...
public class TTMMorgulironBarrelTile extends TileBCore implements ITickableTileEntity, INamedContainerProvider, IRSSwitchable {
   public static final ContainerSlotLayout.LayoutFactory<TTMMorgulironBarrelTile> SLOT_LAYOUT = (player, tile) -> new ContainerSlotLayout().playerMain(player).allTile(tile.itemHandler);
   ...
   public TTMMorgulironBarrelTile() {
      super(TTMContent.BARREL_MORGULIRON_TILE.get());
   ...
   public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity player) {
      return new ContainerBCTile<>(TTMContent.BARREL_MORGULIRON_CONTAINER, id, playerInventory, this, SLOT_LAYOUT);
   }
}