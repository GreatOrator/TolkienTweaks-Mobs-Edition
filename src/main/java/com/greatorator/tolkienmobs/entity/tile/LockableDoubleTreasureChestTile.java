...
public class LockableDoubleTreasureChestTile extends TileBCore implements INamedContainerProvider, ITickableTileEntity {
    public static final ContainerSlotLayout.LayoutFactory<LockableDoubleTreasureChestTile> SLOT_LAYOUT = (player, tile) -> new ContainerSlotLayout().playerMain(player).allTile(tile.mainInventory);
    ...
    public LockableDoubleTreasureChestTile(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public LockableDoubleTreasureChestTile() {
        super(TTMContent.LOCKABLE_DOUBLE_TREASURE_CHEST_TILE.get());
    ...
    public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return new ContainerBCTile<>(TTMContent.LOCKABLE_DOUBLE_TREASURE_CHEST_CONTAINER, windowID, playerInventory, this, SLOT_LAYOUT);
    }
}
