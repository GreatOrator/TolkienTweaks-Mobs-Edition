...
public class LockableDoubleTreasureChestTile extends TileBCore implements MenuProvider, IInteractTile, IAnimatable {
    ...
    public LockableDoubleTreasureChestTile(BlockPos pos, BlockState state) {
        super(TolkienTiles.LOCKABLE_DOUBLE_TREASURE_CHEST_TILE.get(), pos, state);
    ...
    public AbstractContainerMenu createMenu(int windowID, Inventory playerInventory, Player playerEntity) {
        return new ContainerBCTile<>(TolkienContainers.LOCKABLE_DOUBLE_TREASURE_CHEST_CONTAINER, windowID, playerInventory, this, SLOT_LAYOUT);
    }
