...
public class LockableDoubleChestTile extends TileBCore implements INamedContainerProvider, ITickableTileEntity {
    ...
    public LockableDoubleChestTile(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public LockableDoubleChestTile() {
        super(TTMContent.LOCKABLE_DOUBLE_CHEST_TILE.get());
    ...
    public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return new ContainerBCTile<>(TTMContent.LOCKABLE_DOUBLE_CHEST_CONTAINER, windowID, playerInventory, this, SLOT_LAYOUT);
    }
}
