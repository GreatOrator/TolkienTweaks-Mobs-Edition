...
public class ElvesEntity extends VillagerEntity {
    private static final DataParameter<Integer> ELVES_TYPE = EntityDataManager.defineId(ElvesEntity.class, DataSerializers.INT);
    private static final DataParameter<VillagerData> ELVES_DATA = EntityDataManager.defineId(ElvesEntity.class, DataSerializers.VILLAGER_DATA);
    ...
    public ElvesEntity(EntityType<? extends VillagerEntity> type, World worldIn) {
        super(type, worldIn);
