...
public class FlyerWanderGoal extends WaterAvoidingRandomStrollGoal
{
    ...
    public boolean canUse()
    {
        ...
        if (!dragon.isUsingFlyingNavigator() && dragon.hasEntityDataAccessor(DragonEntity.SLEEPING) && !dragon.level.isDay()) return false;
    ...
    public Vec3 getPosition()
    {
        ...
        {
            if ((dragon.hasEntityDataAccessor(DragonEntity.SLEEPING) && !dragon.level.isDay()) || dragon.getRandom().nextFloat() <= probability)
