...
public class DefendHomeGoal extends TargetGoal
{
    ...
    public void start()
    {
        ...
        // alert others!
        for (Mob mob : defender.level.getEntitiesOfClass(Mob.class, defender.getBoundingBox().inflate(TolkienConfig.homeRadius), defender::isAlliedTo))
    ...
    public LivingEntity findPotentialTarget()
    {
        return defender.level.getNearestEntity(LivingEntity.class,
                ...
                defender.getEyeY(),
                defender.getZ(),
                new AABB(defender.getRestrictCenter()).inflate(TolkienConfig.homeRadius));
    }
}
