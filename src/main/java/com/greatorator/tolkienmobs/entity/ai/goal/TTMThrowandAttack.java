...
public class TTMThrowandAttack<T extends CreatureEntity & IRangedAttackMob> extends MeleeAttackGoal {
    ...
    public TTMThrowandAttack(T rangedAttackMob, double speedAmplifier, int attackInterval, float maxDistance, boolean useLongMemory)
    {
