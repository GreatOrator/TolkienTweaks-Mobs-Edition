...
public class EntityTreeEnt extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(TolkienMobs.MODID, "entities/tree_ent");
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(2, new EntityTreeEntAI(this, 1.0D, false));
