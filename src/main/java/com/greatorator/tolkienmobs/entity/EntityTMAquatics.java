...
//        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, LivingEntity.class, 10, true, false, new EntityTMAquatics.TMAquaticsTargetSelector(this)));
//    }
//
...
//        {
//            LivingEntity LivingEntity = this.tmaquatics.getAttackTarget();
...
//            this.tmaquatics.setAttackTarget((LivingEntity)null);
...
//            LivingEntity LivingEntity = this.tmaquatics.getAttackTarget();
//            this.tmaquatics.getNavigator().clearPath();
//            this.tmaquatics.getLookHelper().setLookPositionWithEntity(LivingEntity, 90.0F, 90.0F);
//
//            if (!this.tmaquatics.canEntityBeSeen(LivingEntity) || !hostileWater)
//            {
//                this.tmaquatics.setAttackTarget((LivingEntity)null);
//            }
//            else
...
//                            LivingEntity.addPotionEffect(new PotionEffect(ttmEffect, ttmDuration, 3));
//                        }
//                        else {
//                            LivingEntity.attackEntityFrom(DamageSource.causeIndirectMagicDamage(this.tmaquatics, this.tmaquatics), f);
//                            LivingEntity.attackEntityFrom(DamageSource.causeMobDamage(this.tmaquatics), (float)this.tmaquatics.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue());
//                        }
//                    }
//                    this.tmaquatics.setAttackTarget((LivingEntity)null);
//                }
...
//    }
//
//    static class TMAquaticsTargetSelector implements Predicate<LivingEntity>
//    {
...
//        {
//            return (p_apply_1_ instanceof PlayerEntity || p_apply_1_ instanceof EntitySquid) && p_apply_1_.getDistanceSq(this.parentEntity) > 9.0D;
//        }
//    }
//
//    @Nullable
