...
//    private static final Predicate<ServerPlayerEntity> VALID_PLAYER = Predicates.<ServerPlayerEntity>and(EntitySelectors.IS_ALIVE, EntitySelectors.withinRange(0.0D, 128.0D, 0.0D, 192.0D));
...
//
//                for (ServerPlayerEntity entityplayermp : this.bossInfo.getPlayers())
//                {
...
//        }
//
//        int k = this.world.getHeight(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ)).getY();
//
//        for (int l = k; l >= 0; --l)
//        {
//            BlockPattern.PatternHelper blockpattern$patternhelper1 = this.portalPattern.match(this.world, new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ));
//
...
//
//        for (ServerPlayerEntity entityplayermp : this.world.getPlayers(ServerPlayerEntity.class, VALID_PLAYER))
//        {
...
//        set1.removeAll(set);
//
//        for (ServerPlayerEntity entityplayermp1 : set1)
//        {
...
//            {
//                this.world.setBlockState(this.world.getHeight(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ)), Blocks.DRAGON_EGG.getDefaultState());
//            }
//
//            this.previouslyKilled = true;
//            this.fellbeastKilled = true;
...
//        if (this.exitPortalLocation == null)
//        {
//            for (this.exitPortalLocation = this.world.getTopSolidOrLiquidBlock(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ)).down(); this.world.getBlockState(this.exitPortalLocation).getBlock() == Blocks.BEDROCK && this.exitPortalLocation.getY() > this.world.getSeaLevel(); this.exitPortalLocation = this.exitPortalLocation.down())
//            {
//
//            }
//        }
...
//        this.world.getChunkFromBlockCoords(new BlockPos(TTMConfig_Old.FellBeastX, TTMConfig_Old.FellBeastY, TTMConfig_Old.FellBeastZ));
