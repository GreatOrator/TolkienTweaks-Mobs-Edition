...
//
//            double d0 = 64.0D;
//            PlayerEntity entityplayer = this.fellbeast.world.getNearestAttackablePlayer(blockpos, d0, d0);
//
...
//    }
//
//    public void onCrystalDestroyed(EntityEnderCrystal crystal, BlockPos pos, DamageSource dmgSrc, @Nullable PlayerEntity plyr)
//    {
