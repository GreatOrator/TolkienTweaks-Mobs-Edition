...
public class EntityAITTMSwitch extends EntityAIAttackMelee
{
    private final EntityTMHostiles entity;
    ...
    public EntityAITTMSwitch(EntityTMHostiles haradrim, double speedAmplifier, int delay, float maxDistance)
    {
        super(haradrim, speedAmplifier, false);
        this.entity = haradrim;
