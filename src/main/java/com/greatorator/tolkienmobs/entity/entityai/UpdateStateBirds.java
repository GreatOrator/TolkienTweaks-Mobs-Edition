...
//    {
//        LivingEntity target = theBird.getAttackTarget();
...
//            PlayerEntity closestPlayer = theWorld.getClosestPlayerToEntity(theBird, 4.0D);
...
//    {
//        LivingEntity theOwner = theBird.getOwner();
//
//        if (theOwner == null)
//        {
//            return;
...
//        else
//        {
//            LivingEntity possibleTarget = theOwner.getLastAttackedEntity(); // note the get last attacker actually returns last attacked
...
//            {
//                LivingEntity possibleTarget = (LivingEntity)(targetIterator.next());
