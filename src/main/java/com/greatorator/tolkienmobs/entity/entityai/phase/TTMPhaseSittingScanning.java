...
public class TTMPhaseSittingScanning extends TTMPhaseSittingBase
{
    ...
    {
        ++this.scanningTime;
        EntityLivingBase entitylivingbase = this.fellbeast.world.getNearestAttackablePlayer(this.fellbeast, 20.0D, 10.0D);
        ...
        if (entitylivingbase != null)
        {
            ...
            {
                Vec3d vec3d = (new Vec3d(entitylivingbase.posX - this.fellbeast.posX, 0.0D, entitylivingbase.posZ - this.fellbeast.posZ)).normalize();
                ...
                if (f1 < 0.0F || f1 > 10.0F)
                {
                    double d0 = entitylivingbase.posX - this.fellbeast.fellbeastPartHead.posX;
                    double d1 = entitylivingbase.posZ - this.fellbeast.fellbeastPartHead.posZ;
        ...
        {
            entitylivingbase = this.fellbeast.world.getNearestAttackablePlayer(this.fellbeast, 150.0D, 150.0D);
            ...
            if (entitylivingbase != null)
            {
                ...
                ((TTMPhaseChargingPlayer)this.fellbeast.getFellBeastPhaseManager().getPhase(TTMPhaseList.CHARGING_PLAYER)).setTarget(new Vec3d(entitylivingbase.posX, entitylivingbase.posY, entitylivingbase.posZ));
            }
        }
    }
