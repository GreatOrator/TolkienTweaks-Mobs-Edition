...
public class MorgulCrystalRenderer extends EntityRenderer<MorgulCrystalEntity> {
   ...
   public MorgulCrystalRenderer(EntityRendererManager p_i46184_1_) {
      super(p_i46184_1_);
   ...
   public void render(MorgulCrystalEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (blockpos != null) {
         ...
         FellBeastRender.renderCrystalBeams(-f6, -f7 + f, -f8, p_225623_3_, p_225623_1_.time, p_225623_4_, p_225623_5_, p_225623_6_);
      }
   ...
   public boolean shouldRender(MorgulCrystalEntity p_225626_1_, ClippingHelper p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
