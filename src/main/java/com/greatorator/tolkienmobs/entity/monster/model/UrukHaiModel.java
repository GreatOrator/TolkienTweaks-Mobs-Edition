 ...
 */
public class UrukHaiModel<T extends MonsterEntity> extends BipedModel<T> {
    ...
    public UrukHaiModel(float modelSize, boolean p_i46303_2_) {
        super(modelSize);
