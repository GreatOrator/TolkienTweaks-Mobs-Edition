...
public class ModelTTMMinotaur<T extends MonsterEntity> extends BipedModel<T> {
    ...
    public ModelTTMMinotaur(float modelSize, boolean p_i46303_2_) {
        super(modelSize);
    ...
    public void translateToHand(HandSide hand, MatrixStack matrixStackIn) {
        float pos = hand == HandSide.RIGHT ? 6.5F : -1.0F;
