...
public class EntityTTMRomieWalker extends MonsterEntity {
    ...
    public EntityTTMRomieWalker(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
