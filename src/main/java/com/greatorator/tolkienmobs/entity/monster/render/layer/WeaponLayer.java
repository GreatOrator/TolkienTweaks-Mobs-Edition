package com.greatorator.tolkienmobs.entity.monster.render.layer;
...
public abstract class WeaponLayer<T extends LivingEntity & IAnimatable> extends GeoEntityRenderer<T> {
    protected T tolkienEntity;
    protected RenderType renderType;
    protected abstract ItemStack getHeldItemStack();
    protected abstract String getArmPartName();

    public WeaponLayer(EntityRendererProvider.Context context, AnimatedGeoModel<T> modelProvider) {
    ...
    protected void moveAndRotateMatrixToMatchBone(PoseStack stack, GeoBone bone) {
        stack.translate((bone.getPositionX()) - (-3.5f * 0.1f), (bone.getPositionY()) + (9.1f * 0.1f), (bone.getPositionZ()) - 0.2F);
