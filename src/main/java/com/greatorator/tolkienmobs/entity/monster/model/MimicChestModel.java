...
public class MimicChestModel extends SegmentedModel<MimicChestEntity> {
    ...
    @Override
    public void setupAnim(MimicChestEntity mimic, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
