...
public class EntityTTMHaradrim extends MonsterEntity {
    ...
    static class HaradrimAttackGoal extends TTMThrowandAttack {
        private final EntityTTMHaradrim haradrim;
        private int raiseArmTicks;

        HaradrimAttackGoal(EntityTTMHaradrim haradrimEntity, double speedAmplifier, int attackInterval, float maxDistance, boolean useLongMemory) {
