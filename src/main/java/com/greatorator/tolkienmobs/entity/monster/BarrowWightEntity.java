...
public class BarrowWightEntity extends MonsterEntity {
    private static final DataParameter<Integer> BARROW_TYPE = EntityDataManager.defineId(BarrowWightEntity.class, DataSerializers.INT);
    ...
    public BarrowWightEntity(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
