...
public class EntityTTMBrigand extends MonsterEntity {
    ...
    public EntityTTMBrigand(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
