...
public class MinotaurEntity extends MonsterEntity {
    private static final DataParameter<Integer> MINOTAUR_TYPE = EntityDataManager.defineId(MinotaurEntity.class, DataSerializers.INT);
    ...
    private final MeleeAttackGoal meleeGoal = new MeleeAttackGoal(this, 1.2D, false) {
        ...
        public void stop() {
            super.stop();
            MinotaurEntity.this.setAggressive(false);
        }

        @Override
        public void start() {
            super.start();
            MinotaurEntity.this.setAggressive(true);
        }
    };
    /** End Region **/

    public MinotaurEntity(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static boolean checkMinotaurSpawn(EntityType<MinotaurEntity> type, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
