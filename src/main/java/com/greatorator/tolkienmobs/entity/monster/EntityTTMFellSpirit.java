...
public class EntityTTMFellSpirit extends MonsterEntity {
    ...
    public EntityTTMFellSpirit(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
