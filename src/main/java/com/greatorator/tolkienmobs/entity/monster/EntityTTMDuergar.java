...
public class EntityTTMDuergar extends MonsterEntity {
    ...
    public EntityTTMDuergar(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
