...
public class EntityTTMDeepClaw extends MonsterEntity {
    ...
    public EntityTTMDeepClaw(EntityType<? extends net.minecraft.entity.monster.MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
