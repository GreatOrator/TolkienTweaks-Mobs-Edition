...
public class WargEntity extends WolfEntity {
    private static final DataParameter<Integer> WARG_TYPE = EntityDataManager.defineId(WargEntity.class, DataSerializers.INT);
    ...
    public WargEntity(EntityType<? extends WolfEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
        ...
        if (TTMRand.getRandomInteger(15, 1) == 2) {
            MordorOrcEntity entitymordororc = EntityGenerator.ENTITY_TTM_MORDORORC.get().create(this.level);
