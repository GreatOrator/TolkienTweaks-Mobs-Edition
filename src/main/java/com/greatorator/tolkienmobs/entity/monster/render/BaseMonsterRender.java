...
public abstract class BaseMonsterRender<T extends LivingEntity & IAnimatable> extends GeoEntityRenderer<T> {
    protected T tolkienEntity;
    protected RenderType renderType;
    protected abstract ItemStack getHeldItemStack();
    protected abstract String getArmPartName();

    public BaseMonsterRender(EntityRendererProvider.Context context, AnimatedGeoModel<T> modelProvider) {
