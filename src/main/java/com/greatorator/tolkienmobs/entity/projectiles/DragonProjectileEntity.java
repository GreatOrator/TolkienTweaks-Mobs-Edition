...
public class DragonProjectileEntity extends Projectile implements IEntityAdditionalSpawnData, IAnimatable {
    @Nullable
    public DragonEntity shooter;
    ...
    public DragonProjectileEntity(EntityType<? extends DragonProjectileEntity> type, DragonEntity shooter, Vec3 position, Vec3 direction) {
    ...
    public void readSpawnData(FriendlyByteBuf buf) {
        this.shooter = (DragonEntity) level.getEntity(buf.readInt());
