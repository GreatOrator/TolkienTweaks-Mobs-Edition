...
public class EntityTippedGaladhrimArrow extends EntityGaladhrimArrow
{
    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntityTippedGaladhrimArrow.class, DataSerializers.VARINT);
    private PotionType potion = PotionTypes.EMPTY;
    private final Set<PotionEffect> customPotionEffects = Sets.<PotionEffect>newHashSet();
    private boolean fixedColor;

    public EntityTippedGaladhrimArrow(World worldIn)
    {
        super(worldIn);
    }

    public EntityTippedGaladhrimArrow(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityTippedGaladhrimArrow(World worldIn, EntityLivingBase shooter)
    {
