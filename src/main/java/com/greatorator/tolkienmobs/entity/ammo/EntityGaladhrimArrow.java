...
import com.greatorator.tolkienmobs.handler.TTMDamageSource;
...
public abstract class EntityGaladhrimArrow extends EntityArrow
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityGaladhrimArrow.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityGaladhrimArrow.PickupStatus pickupStatus;
    ...
    public EntityGaladhrimArrow(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityGaladhrimArrow.PickupStatus.DISALLOWED;
        this.damage = 6.0D;
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                damagesource = TTMDamageSource.causeArrowDamage(this, this);
            }
            else
            {
                damagesource = TTMDamageSource.causeArrowDamage(this, this.shootingEntity);
            }
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityGaladhrimArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityGaladhrimArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityGaladhrimArrow.PickupStatus.ALLOWED : EntityGaladhrimArrow.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityGaladhrimArrow.PickupStatus.ALLOWED || this.pickupStatus == EntityGaladhrimArrow.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityGaladhrimArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityGaladhrimArrow.PickupStatus getByOrdinal(int ordinal)
        {
