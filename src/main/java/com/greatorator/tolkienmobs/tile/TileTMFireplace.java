...
public class TileTMFireplace extends TileEntity implements ITickable {
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.tmfireplace");
    }
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
//            BlockTMFireplace.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = TMFireplaceRecipes.getInstance().getFireplaceResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = TMFireplaceRecipes.getInstance().getFireplaceResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));
