...
public abstract class TTMArea implements Iterator<BlockPos> {
    ...
    public abstract boolean intersects(TTMArea descriptor);

    public abstract TTMArea offset(BlockPos offset);

    public abstract TTMArea rotateDescriptor(PlacementSettings settings);

    public static class Rectangle extends TTMArea
    {
        ...
        public Rectangle(TTMArea.Rectangle rectangle)
        {
            this(rectangle.minimumOffset, rectangle.maximumOffset);
        }

        public TTMArea.Rectangle copy()
        {
            return new TTMArea.Rectangle(this);
        }
        ...
        /**
         * Sets the offsets of the TTMArea in a safe way that will make
        ...
        public void readFromNBT(CompoundNBT tag)
        {
            minimumOffset = new BlockPos(tag.getInt(TTMReference.NBT.X_COORD + "min"), tag.getInt(TTMReference.NBT.Y_COORD + "min"), tag.getInt(TTMReference.NBT.Z_COORD + "min"));
            maximumOffset = new BlockPos(tag.getInt(TTMReference.NBT.X_COORD + "max"), tag.getInt(TTMReference.NBT.Y_COORD + "max"), tag.getInt(TTMReference.NBT.Z_COORD + "max"));
        }

        @Override
        public void writeToNBT(CompoundNBT tag)
        {
            tag.putInt(TTMReference.NBT.X_COORD + "min", minimumOffset.getX());
            tag.putInt(TTMReference.NBT.Y_COORD + "min", minimumOffset.getY());
            tag.putInt(TTMReference.NBT.Z_COORD + "min", minimumOffset.getZ());
            tag.putInt(TTMReference.NBT.X_COORD + "max", maximumOffset.getX());
            tag.putInt(TTMReference.NBT.Y_COORD + "max", maximumOffset.getY());
            tag.putInt(TTMReference.NBT.Z_COORD + "max", maximumOffset.getZ());
        }
        ...
        @Override
        public boolean intersects(TTMArea descriptor)
        {
            if (descriptor instanceof TTMArea.Rectangle)
            {
                TTMArea.Rectangle rectangle = (TTMArea.Rectangle) descriptor;
        ...
        @Override
        public TTMArea offset(BlockPos offset)
        {
            return new TTMArea.Rectangle(this.minimumOffset.offset(offset), this.maximumOffset.offset(offset));
        }

        @Override
        public TTMArea rotateDescriptor(PlacementSettings settings)
        {
            BlockPos rotatePos1 = Template.calculateRelativePosition(settings, minimumOffset);
            BlockPos rotatePos2 = Template.calculateRelativePosition(settings, maximumOffset.offset(-1, -1, -1));

            TTMArea.Rectangle rectangle = new TTMArea.Rectangle(this.minimumOffset, 1);
    ...
    public static class HemiSphere extends TTMArea
    {
        ...
        public HemiSphere(TTMArea.HemiSphere hemiSphere)
        {
            this(hemiSphere.minimumOffset, hemiSphere.radius);
        }

        public TTMArea.HemiSphere copy()
        {
            return new TTMArea.HemiSphere(this);
        }
        ...
        public TTMArea offset(BlockPos offset)
        {
            return new TTMArea.HemiSphere(minimumOffset.offset(offset), radius);
        }
    ...
    public static class Cross extends TTMArea
    {
        ...
        public Cross(TTMArea.Cross cross)
        {
            this(cross.centerPos, cross.size);
        }

        public TTMArea.Cross copy()
        {
            return new TTMArea.Cross(this);
        }
        ...
        public TTMArea offset(BlockPos offset)
        {
            return new TTMArea.Cross(centerPos.offset(offset), size);
        }
