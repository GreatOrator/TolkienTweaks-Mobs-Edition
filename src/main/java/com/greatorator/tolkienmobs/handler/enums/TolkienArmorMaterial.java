...
public enum TolkienArmorMaterial implements ArmorMaterial {
    ...
    private TolkienArmorMaterial(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
