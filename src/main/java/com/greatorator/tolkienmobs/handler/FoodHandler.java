...
public class FoodHandler extends Item {
    public boolean hasEffectOverride = false;
    public boolean hasDrinkAction = false;

    public FoodHandler(Properties properties) {
        super(properties);
    }

    public FoodHandler setEffectOverride() {
    ...
    public FoodHandler setItemUseAction(boolean getUseAction) {
