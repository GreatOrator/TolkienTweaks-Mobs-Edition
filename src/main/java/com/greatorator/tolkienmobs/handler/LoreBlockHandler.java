...
public class LoreBlockHandler extends ItemBlockBCore {
    ...
    public LoreBlockHandler(Block block, Item.Properties builder) {
        super(block, builder);
    ...
    public LoreBlockHandler setEffectOverride() {
        this.hasEffectOverride = true;
        return this;
    }

    public LoreBlockHandler setHasLore() {
        this.hasLore = true;
        return this;
    }

    public LoreBlockHandler setItemHasUse() {
        this.itemHasUse = true;
        return this;
    }

    public LoreBlockHandler setSpawnInfo() {
