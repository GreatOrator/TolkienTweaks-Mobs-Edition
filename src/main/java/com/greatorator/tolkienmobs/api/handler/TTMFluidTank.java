...
public class TTMFluidTank implements ITTMFluidModifiable {
    ...
    public TTMFluidTank(int capacity) {
        this(capacity, e -> true);
    }

    public TTMFluidTank(int capacity, Predicate<FluidStack> validator) {
        this.capacity = capacity;
        this.validator = validator;
    }

    public TTMFluidTank setValidator(Predicate<FluidStack> validator) {
        if (validator != null) {
            this.validator = validator;
        }
        return this;
    ...
    public TTMFluidTank read(CompoundNBT nbt) {
    ...
    public TTMFluidTank setCapacity(int capacity) {
        this.capacity = capacity;
        return this;
    }
