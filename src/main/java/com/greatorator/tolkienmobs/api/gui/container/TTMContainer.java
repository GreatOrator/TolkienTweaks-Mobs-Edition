package com.greatorator.tolkienmobs.api.gui.container;

import com.google.common.collect.Lists;
import com.greatorator.tolkienmobs.api.tileentity.TTMTile;
...
public class TTMContainer<T extends TTMTile<?>> extends Container {
    ...
    public TTMContainer(ContainerType<?> type, int inventorySize, int id, World world, BlockPos pos, PlayerInventory playerInv) {
        this(type, inventorySize, id, world, pos, playerInv, null);
    }

    public TTMContainer(ContainerType<?> type, int inventorySize, int id, World world, BlockPos pos, PlayerInventory playerInv, @Nullable T tile) {
        super(type, id);
