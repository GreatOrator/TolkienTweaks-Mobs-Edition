package com.greatorator.tolkienmobs.api.recipe;
...
public abstract class TTMRecipe implements IRecipe<TTMCombinedInventory> {
    ...
    protected TTMRecipe(ResourceLocation id, int resource, int time, List<Ingredient> inputItems, List<FluidStack> inputFluids, List<ItemStack> outputItems, List<Float> outputItemChances, List<FluidStack> outputFluids) {
        this.id = id;
    ...
    public List<Integer> getInputItemCounts(TTMInventory inventory) {
    ...
    public List<Integer> getInputFluidCounts(TTMFluidInventory tankInventory) {
    ...
    @Override
    public boolean matches(@Nonnull TTMCombinedInventory inv, @Nonnull World worldIn) {
        TTMInventory inventory = inv.inventory;
        ...
        TTMFluidInventory tankInventory = inv.tankInventory;
    ...
    @Nonnull
    @Override
    public ItemStack assemble(@Nonnull TTMCombinedInventory inv) {
