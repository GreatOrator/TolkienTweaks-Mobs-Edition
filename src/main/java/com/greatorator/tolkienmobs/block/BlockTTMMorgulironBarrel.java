...
public class BlockTTMMorgulironBarrel extends Block {
   public static final DirectionProperty FACING = BlockStateProperties.FACING;
   public static final BooleanProperty OPEN = BlockStateProperties.OPEN;

   public BlockTTMMorgulironBarrel(Properties properties) {
      super(properties);
   ...
   public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult trace) {
      if (!world.isClientSide) {
         ...
         if (tileEntity instanceof TTMMorgulironBarrelTile) {
            NetworkHooks.openGui((ServerPlayerEntity) entity, (TTMMorgulironBarrelTile) tileEntity, pos);
   ...
   public TileEntity createTileEntity(BlockState state, IBlockReader world) {
      return new TTMMorgulironBarrelTile();
   }
