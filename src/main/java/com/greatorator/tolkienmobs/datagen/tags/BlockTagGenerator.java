...
public class BlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(Tags.Blocks.STORAGE_BLOCKS).add(TolkienBlocks.BLOCK_MITHRIL.get(), TolkienBlocks.BLOCK_MORGULIRON.get(), TolkienBlocks.RAW_MITHRIL_BLOCK.get(), TolkienBlocks.RAW_MORGULIRON_BLOCK.get(), TolkienBlocks.BLOCK_AMMOLITE.get());
        ...
        // Mineable tools
        tag(MINEABLE_WITH_AXE).add(TolkienBlocks.LOG_MALLORN.get(), TolkienBlocks.LOG_MIRKWOOD.get(), TolkienBlocks.LOG_CULUMALDA.get(), TolkienBlocks.LOG_LEBETHRON.get(), TolkienBlocks.LOG_DEADWOOD.get(), TolkienBlocks.STRIPPED_MALLORN_LOG.get(), TolkienBlocks.STRIPPED_MIRKWOOD_LOG.get(), TolkienBlocks.STRIPPED_CULUMALDA_LOG.get(), TolkienBlocks.STRIPPED_LEBETHRON_LOG.get(), TolkienBlocks.STRIPPED_MALLORN_WOOD.get(), TolkienBlocks.STRIPPED_MIRKWOOD_WOOD.get(), TolkienBlocks.STRIPPED_CULUMALDA_WOOD.get(), TolkienBlocks.STRIPPED_LEBETHRON_WOOD.get(), TolkienBlocks.WOOD_MALLORN.get(), TolkienBlocks.WOOD_MIRKWOOD.get(), TolkienBlocks.WOOD_CULUMALDA.get(), TolkienBlocks.WOOD_LEBETHRON.get(), TolkienBlocks.PLANKS_MALLORN.get(), TolkienBlocks.PLANKS_MIRKWOOD.get(), TolkienBlocks.PLANKS_CULUMALDA.get(), TolkienBlocks.PLANKS_LEBETHRON.get(), TolkienBlocks.FENCE_MALLORN.get(), TolkienBlocks.FENCE_MIRKWOOD.get(), TolkienBlocks.FENCE_GATE_CULUMALDA.get(), TolkienBlocks.FENCE_LEBETHRON.get(), TolkienBlocks.FENCE_GATE_MALLORN.get(), TolkienBlocks.FENCE_GATE_MIRKWOOD.get(), TolkienBlocks.FENCE_GATE_CULUMALDA.get(), TolkienBlocks.FENCE_GATE_LEBETHRON.get(), TolkienBlocks.STAIRS_MALLORN.get(), TolkienBlocks.STAIRS_MIRKWOOD.get(), TolkienBlocks.STAIRS_CULUMALDA.get(), TolkienBlocks.STAIRS_LEBETHRON.get(), TolkienBlocks.BARREL_MITHRIL.get(), TolkienBlocks.BARREL_MORGULIRON.get(), TolkienBlocks.BARREL_MALLORN.get(), TolkienBlocks.BARREL_MIRKWOOD.get(), TolkienBlocks.BARREL_CULUMALDA.get(), TolkienBlocks.BARREL_LEBETHRON.get(), TolkienBlocks.BARREL_DEADWOOD.get(), TolkienBlocks.BARREL_FANGORNOAK.get(), TolkienBlocks.DOOR_MALLORN.get(), TolkienBlocks.DOOR_MIRKWOOD.get(), TolkienBlocks.DOOR_CULUMALDA.get(), TolkienBlocks.DOOR_LEBETHRON.get(), TolkienBlocks.BLOCK_BLOOM_DECAY.get(), TolkienBlocks.BLOCK_DECAY_BLOOM.get());
        tag(MINEABLE_WITH_HOE).add(TolkienBlocks.LEAVES_MALLORN.get(), TolkienBlocks.LEAVES_MIRKWOOD.get(), TolkienBlocks.LEAVES_CULUMALDA.get(), TolkienBlocks.LEAVES_LEBETHRON.get(), TolkienBlocks.LEAVES_FANGORNOAK.get(), TolkienBlocks.LEAFPILE_MALLORN.get(), TolkienBlocks.LEAFPILE_MIRKWOOD.get(), TolkienBlocks.LEAFPILE_CULUMALDA.get(), TolkienBlocks.LEAFPILE_LEBETHRON.get(), TolkienBlocks.LEAFPILE_FANGORNOAK.get());
        ...
        tag(NEEDS_DIAMOND_TOOL).add(TolkienBlocks.ORE_MITHRIL.get(), TolkienBlocks.ORE_END_MITHRIL.get(), TolkienBlocks.ORE_NETHER_MITHRIL.get(), TolkienBlocks.ORE_DEEPSLATE_MITHRIL.get(), TolkienBlocks.ORE_MORGULIRON.get(), TolkienBlocks.ORE_END_MORGULIRON.get(), TolkienBlocks.ORE_NETHER_MORGULIRON.get(), TolkienBlocks.ORE_DEEPSLATE_MORGULIRON.get(), TolkienBlocks.ORE_AMMOLITE.get(), TolkienBlocks.ORE_END_AMMOLITE.get(), TolkienBlocks.ORE_NETHER_AMMOLITE.get(), TolkienBlocks.ORE_DEEPSLATE_AMMOLITE.get());
