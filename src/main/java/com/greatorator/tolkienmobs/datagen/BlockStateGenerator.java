...
public class BlockStateGenerator extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(TTMContent.BLOCK_AMMOLITE.get());
        ...
        horizontalBlock(TTMContent.LOCKABLE_TREASURE_CHEST_BLOCK.get(), models().getExistingFile(modLoc("block/lockable_treasure_chest_block")), 180);
        horizontalBlock(TTMContent.LOCKABLE_DOUBLE_CHEST_BLOCK.get(), models().getExistingFile(modLoc("block/lockable_double_chest_block")), 180);
        horizontalBlock(TTMContent.LOCKABLE_DOUBLE_TREASURE_CHEST_BLOCK.get(), models().getExistingFile(modLoc("block/lockable_double_treasure_chest_block")), 180);
