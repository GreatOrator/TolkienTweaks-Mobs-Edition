...
//    public static final RegistryObject<Enchantment> HOBBIT_HARVEST = ENCHANTS.register("hobbit_harvest", () -> new EnchantmentHobbitPlow(Enchantment.Rarity.RARE, EquipmentSlotType.MAINHAND));
