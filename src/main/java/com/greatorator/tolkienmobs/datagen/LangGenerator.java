...
public class LangGenerator extends LanguageProvider {
    ...
    private void blocks() {
        ...
        add(TTMContent.LEBETHRON_BUTTON.get(), "Lebethron Button");
        ...
        add(TTMContent.MALLORN_BOAT.get(), "Mallorn Boat");
        add(TTMContent.MIRKWOOD_BOAT.get(), "Mirkwood Boat");
        add(TTMContent.CULUMALDA_BOAT.get(), "Culumalda Boat");
        add(TTMContent.LEBETHRON_BOAT.get(), "Lebethron Boat");
        ...
        add(TTMContent.MALLORN_SIGN.get(), "Mallorn Sign");
        add(TTMContent.MIRKWOOD_SIGN.get(), "Mirkwood Sign");
        add(TTMContent.CULUMALDA_SIGN.get(), "Culumalda Sign");
        add(TTMContent.LEBETHRON_SIGN.get(), "Lebethron Sign");
        ...
        add(TTMContent.LOCKABLE_DOUBLE_CHEST_BLOCK.get(), "Lockable Double Chest");
