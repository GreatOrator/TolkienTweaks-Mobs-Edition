...
public class EntityGenerator {
    ...
    public static final RegistryObject<EntityType<FellBeastFireballEntity>> AMMO_FELLBEAST_FIREBALL = ENTITY.register("ammo_fellbeast_fireball", () -> EntityType.Builder.of((EntityType.IFactory<FellBeastFireballEntity>) FellBeastFireballEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(MODID + ":ammo_fellbeast_fireball"));
    public static final RegistryObject<EntityType<BoulderEntity>> AMMO_BOULDER = ENTITY.register("ammo_boulder", () -> EntityType.Builder.of((EntityType.IFactory<BoulderEntity>) BoulderEntity::new, EntityClassification.MISC).sized(0.5F, 0.5F).build(MODID + ":ammo_boulder"));
