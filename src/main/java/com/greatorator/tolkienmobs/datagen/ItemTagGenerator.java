...
public class ItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(TTMTags.items.SIGNS).add(TTMContent.ITEM_PLACARD.get(), TTMContent.MALLORN_SIGN_ITEM.get(), TTMContent.MIRKWOOD_SIGN_ITEM.get(), TTMContent.CULUMALDA_SIGN_ITEM.get(), TTMContent.LEBETHRON_SIGN_ITEM.get());
