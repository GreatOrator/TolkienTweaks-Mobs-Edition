...
//        getOrCreateBuilder(Tags.Items.MUSHROOMS).addTag(TTMTags.items.MUSHROOMS);
        ...
        getOrCreateBuilder(ItemTags.WOODEN_FENCES).addTag(TTMTags.items.FENCES_WOODEN);
        ...
        getOrCreateBuilder(Tags.Items.FENCE_GATES).addTag(TTMTags.items.FENCE_GATES_WOODEN);
        getOrCreateBuilder(TTMTags.items.SAPLINGS).add(TTMContent.SAPLING_MALLORN_ITEM.get(),TTMContent.SAPLING_MIRKWOOD_ITEM.get(), TTMContent.SAPLING_CULUMALDA_ITEM.get(), TTMContent.SAPLING_LEBETHRON_ITEM.get(), TTMContent.SAPLING_DEADWOOD_ITEM.get());
        getOrCreateBuilder(ItemTags.SAPLINGS).addTag(TTMTags.items.SAPLINGS);
        ...
        getOrCreateBuilder(ItemTags.LEAVES).addTag(TTMTags.items.LEAVES);
        ...
        getOrCreateBuilder(ItemTags.PLANKS).addTag(TTMTags.items.PLANKS);
        ...
        getOrCreateBuilder(ItemTags.STAIRS).addTag(TTMTags.items.STAIRS);
        ...
        getOrCreateBuilder(ItemTags.WOODEN_SLABS).addTag(TTMTags.items.SLABS);
        ...
        getOrCreateBuilder(ItemTags.LOGS_THAT_BURN).addTag(TTMTags.items.LOGS);
        ...
        getOrCreateBuilder(ItemTags.FLOWERS).addTag(TTMTags.items.FLOWERS);
        ...
        getOrCreateBuilder(ItemTags.WOODEN_DOORS).addTag(TTMTags.items.DOORS_WOODEN);
        getOrCreateBuilder(TTMTags.items.DOORS_IRON).add(TTMContent.DOOR_MITHRIL_ITEM.get(), TTMContent.DOOR_MORGULIRON_ITEM.get());
        getOrCreateBuilder(ItemTags.DOORS).addTag(TTMTags.items.DOORS_IRON);
