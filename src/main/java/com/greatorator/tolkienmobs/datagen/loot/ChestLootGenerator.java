                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(ItemLootEntry.lootTableItem(TTMContent.HONEY_CAKE.get())
                                        .setWeight(12)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 3))))
                                .add(ItemLootEntry.lootTableItem(Items.DIAMOND_AXE)
                                        .setWeight(15)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 3))))
                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(ItemLootEntry.lootTableItem(TTMContent.DRINK_ENT_DRAUGHT.get())
                                        .setWeight(15)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 1))))
                                .add(ItemLootEntry.lootTableItem(TTMContent.GEM_AMMOLITE.get())
                                        .setWeight(20)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 3))))
                                .add(ItemLootEntry.lootTableItem(TTMContent.INGOT_MORGULIRON.get())
                                        .setWeight(2)
                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(ItemLootEntry.lootTableItem(TTMContent.MONSTER_FLESH.get())
                                        .setWeight(10)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 3))))
                                .add(ItemLootEntry.lootTableItem(TTMContent.NUGGET_MORGULIRON.get())
                                        .setWeight(15)
                                        .apply(SetCount.setCount(RandomValueRange.between(1, 7))))
                                .add(ItemLootEntry.lootTableItem(TTMContent.ITEM_COIN_GOLD.get())
                                        .setWeight(10)
