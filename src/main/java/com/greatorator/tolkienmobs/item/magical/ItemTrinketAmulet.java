...
public class ItemTrinketAmulet extends ItemBCore implements IBauble {
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> subItems) {
        if(tab == getCreativeTab()) {
            ...
            for(Potion p : ItemTrinketAmulet.DEFAULT_EFFECTS)
    ...
    public static ItemStack getTrinketForPotion(Potion potion) {
        ...
        ItemStack stack = new ItemStack(TTMFeatures.TRINKET_AMULET, 1, 1);
