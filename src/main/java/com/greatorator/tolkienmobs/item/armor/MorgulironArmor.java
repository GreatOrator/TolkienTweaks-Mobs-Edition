...
public class MorgulironArmor extends ArmorItem {
    ...
    public MorgulironArmor(IArmorMaterial material, EquipmentSlotType slot, Properties properties)
    {
        this("", material, slot, properties);
    }

    public MorgulironArmor(String texture, IArmorMaterial material, EquipmentSlotType slot, Properties properties)
    {
