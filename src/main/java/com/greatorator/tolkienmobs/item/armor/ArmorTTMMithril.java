...
public class ArmorTTMMithril extends ArmorItem {
    @OnlyIn(Dist.CLIENT)
    private BipedModel model;
    private final String texture;

    public ArmorTTMMithril(IArmorMaterial material, EquipmentSlotType slot, Properties properties)
    {
        this("", material, slot, properties);
    }

    public ArmorTTMMithril(String texture, IArmorMaterial material, EquipmentSlotType slot, Properties properties)
    {
