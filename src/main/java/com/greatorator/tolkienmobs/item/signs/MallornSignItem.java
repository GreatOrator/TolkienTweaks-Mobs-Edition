...
import com.greatorator.tolkienmobs.container.gui.MallornSignScreen;
...
public class MallornSignItem extends WallOrFloorItem {
   public MallornSignItem(Item.Properties properties, Block signBlock, Block wallSignBlock) {
