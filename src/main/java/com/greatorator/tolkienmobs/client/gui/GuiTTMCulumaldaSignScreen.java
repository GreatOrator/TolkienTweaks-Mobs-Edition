...
import com.greatorator.tolkienmobs.client.render.tile.RenderTTMCulumaldaSignTile;
 ...
 */
public class GuiTTMCulumaldaSignScreen extends Screen {
    private final RenderTTMCulumaldaSignTile.SignModel signModel = new RenderTTMCulumaldaSignTile.SignModel();
    private final TTMCulumaldaSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public GuiTTMCulumaldaSignScreen(TTMCulumaldaSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderTTMCulumaldaSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
