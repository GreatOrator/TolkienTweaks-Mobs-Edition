...
import com.greatorator.tolkienmobs.client.render.tile.RenderMallornSignTile;
 ...
 */
public class MallornSignScreen extends Screen {
    private final RenderMallornSignTile.SignModel signModel = new RenderMallornSignTile.SignModel();
    private final MallornSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public MallornSignScreen(MallornSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderMallornSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
