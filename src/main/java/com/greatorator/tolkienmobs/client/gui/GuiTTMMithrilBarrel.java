...
public class GuiTTMMithrilBarrel extends ModularGuiContainer<ContainerBCTile<TTMMithrilBarrelTile>> {

    protected GuiToolkit<GuiTTMMithrilBarrel> toolkit = new GuiToolkit<>(this, WIDE_EXTRA_TALL).setTranslationPrefix("gui.tolkienmobs.barrel_mithril");

    private TTMMithrilBarrelTile tile;

    public GuiTTMMithrilBarrel(ContainerBCTile<TTMMithrilBarrelTile> container, PlayerInventory inv, ITextComponent title) {
