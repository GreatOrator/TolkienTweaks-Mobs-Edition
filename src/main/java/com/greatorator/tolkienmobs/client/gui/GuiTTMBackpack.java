...
public class GuiTTMBackpack extends ModularGuiContainer<ContainerBCTile<TTMBackpackTile>> {

    protected GuiToolkit<GuiTTMBackpack> toolkit = new GuiToolkit<>(this, WIDE_EXTRA_TALL).setTranslationPrefix("gui.tolkienmobs.backpack");

    private TTMBackpackTile tile;

    public GuiTTMBackpack(ContainerBCTile<TTMBackpackTile> container, PlayerInventory inv, ITextComponent title) {
