...
import com.greatorator.tolkienmobs.client.render.tile.RenderTTMLebethronSignTile;
 ...
 */
public class GuiTTMLebethronSignScreen extends Screen {
    private final RenderTTMLebethronSignTile.SignModel signModel = new RenderTTMLebethronSignTile.SignModel();
    private final TTMLebethronSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public GuiTTMLebethronSignScreen(TTMLebethronSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderTTMLebethronSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
