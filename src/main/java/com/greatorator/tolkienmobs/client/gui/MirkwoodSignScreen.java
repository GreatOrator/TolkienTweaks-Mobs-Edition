...
import com.greatorator.tolkienmobs.client.render.tile.RenderMirkwoodSignTile;
 ...
 */
public class MirkwoodSignScreen extends Screen {
    private final RenderMirkwoodSignTile.SignModel signModel = new RenderMirkwoodSignTile.SignModel();
    private final MirkwoodSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public MirkwoodSignScreen(MirkwoodSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderMirkwoodSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
