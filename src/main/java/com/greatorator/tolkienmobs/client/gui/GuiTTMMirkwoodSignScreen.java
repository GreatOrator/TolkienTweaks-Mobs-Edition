...
import com.greatorator.tolkienmobs.client.render.tile.RenderTTMMirkwoodSignTile;
 ...
 */
public class GuiTTMMirkwoodSignScreen extends Screen {
    private final RenderTTMMirkwoodSignTile.SignModel signModel = new RenderTTMMirkwoodSignTile.SignModel();
    private final TTMMirkwoodSignTile sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public GuiTTMMirkwoodSignScreen(TTMMirkwoodSignTile p_i1097_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderTTMMirkwoodSignTile.SignModel var10002 = this.signModel;
        var10002.getClass();
