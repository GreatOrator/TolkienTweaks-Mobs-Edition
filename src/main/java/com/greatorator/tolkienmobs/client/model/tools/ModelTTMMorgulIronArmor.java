package com.greatorator.tolkienmobs.client.model.tools;//package com.greatorator.tolkienmobs.client.render.model.items;
 ...
 */
public class ModelTTMMorgulIronArmor extends BipedModel {
    ...
    public ModelTTMMorgulIronArmor(float slot) {
        super(slot);
        this.texWidth = 128;
        this.texHeight = 128;
