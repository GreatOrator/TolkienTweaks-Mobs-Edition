...
public class RenderCamoChestTile extends TileEntityRenderer<CamoChestTile> {
    public RenderCamoChestTile(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(CamoChestTile te, float partialTicks, MatrixStack mStack, IRenderTypeBuffer getter, int packedLight, int packedOverlay) {
