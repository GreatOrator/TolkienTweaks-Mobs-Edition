 ...
 */
public class RenderTTMMallornSignTile extends TileEntityRenderer<TTMMallornSignTile> {
    private final SignTileEntityRenderer.SignModel signModel = new SignTileEntityRenderer.SignModel();

    public RenderTTMMallornSignTile(TileEntityRendererDispatcher p_i226014_1_) {
        super(p_i226014_1_);
    }

    @Override
    public void render(TTMMallornSignTile p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
