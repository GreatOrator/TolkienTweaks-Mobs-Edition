...
public class ModelTMGwaihir extends ModelTTM {
    ...
    public ModelTMGwaihir() {
        ...
        this.Toe3R.setRotationPoint(2.2F, 0.5F, -1.0F);
        ...
        this.Leg2L.setRotationPoint(0.5F, 5.4F, 0.5F);
        this.Leg2L.addBox(-2.0F, 0.0F, -2.0F, 3, 6, 3, 0.0F);
        this.Toe2L = new ModelRenderer(this, 50, 105);
        this.Toe2L.setRotationPoint(-0.6F, 0.5F, -2.9F);
        ...
        this.Head.setRotationPoint(0.0F, -3.0F, -10.5F);
        this.Head.addBox(-3.5F, -3.5F, -11.0F, 7, 7, 11, 0.0F);
        this.setRotateAngle(Head, 0.5235987755982988F, 0.0F, 0.0F);
        this.Toe3R_1 = new ModelRenderer(this, 55, 109);
        this.Toe3R_1.setRotationPoint(0.0F, 0.0F, -1.9F);
        this.Toe3R_1.addBox(-2.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(Toe3R_1, 0.31590459461097364F, 0.0F, 0.0F);
        this.BeakUpper = new ModelRenderer(this, 0, 118);
        this.BeakUpper.setRotationPoint(0.0F, 0.0F, -10.5F);
        this.BeakUpper.addBox(-1.5F, -1.5F, -7.0F, 3, 3, 7, 0.0F);
        this.setRotateAngle(BeakUpper, 0.08726646259971647F, 0.08726646259971647F, -0.7853981633974483F);
        this.WingL = new ModelRenderer(this, -31, 55);
        this.WingL.setRotationPoint(4.2F, -4.5F, -6.0F);
        this.WingL.addBox(0.0F, 0.0F, -7.5F, 55, 0, 31, 0.0F);
        this.WingboneR_1 = new ModelRenderer(this, 55, 86);
        this.WingboneR_1.setRotationPoint(5.2F, -0.1F, -0.2F);
        ...
        this.Toe2R.setRotationPoint(-0.6F, 0.5F, -2.9F);
        ...
        this.LegR.setRotationPoint(-2.7F, 2.0F, 5.0F);
        this.LegR.addBox(-4.0F, 0.0F, -2.0F, 5, 7, 5, 0.0F);
        this.BeakLower = new ModelRenderer(this, 20, 119);
        this.BeakLower.setRotationPoint(0.0F, 1.5F, -10.0F);
        this.BeakLower.addBox(-1.5F, -1.5F, -6.0F, 3, 3, 6, 0.0F);
        this.setRotateAngle(BeakLower, -0.08726646259971647F, -0.08726646259971647F, -0.7853981633974483F);
        this.FootL = new ModelRenderer(this, 49, 100);
        this.FootL.setRotationPoint(0.0F, 4.7F, -0.6F);
        ...
        this.Toe2L_1.setRotationPoint(0.0F, 0.0F, -1.9F);
        this.Toe2L_1.addBox(-2.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(Toe2L_1, 0.31590459461097364F, 0.0F, 0.0F);
        this.Toe4L_1 = new ModelRenderer(this, 55, 109);
        this.Toe4L_1.setRotationPoint(0.0F, 0.0F, -1.9F);
        this.Toe4L_1.addBox(-0.5F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(Toe4L_1, 0.31590459461097364F, 0.0F, 0.0F);
        this.Leg1L = new ModelRenderer(this, 65, 100);
        this.Leg1L.setRotationPoint(0.5F, 5.4F, 1.0F);
        ...
        this.WingboneR_2.setRotationPoint(33.0F, -0.1F, 0.0F);
        this.WingboneR_2.addBox(0.0F, 0.0F, 0.0F, 14, 1, 1, 0.0F);
        this.setRotateAngle(WingboneR_2, 0.0F, 0.460766922526503F, 0.0F);
        this.Toe1R_1 = new ModelRenderer(this, 55, 109);
        this.Toe1R_1.setRotationPoint(0.0F, 0.0F, -1.9F);
        this.Toe1R_1.addBox(-2.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(Toe1R_1, 0.31590459461097364F, 0.0F, 0.0F);
        this.Body = new ModelRenderer(this, 38, 95);
        this.Body.setRotationPoint(0.0F, 5.6F, 8.0F);
        ...
        this.WingboneR.setRotationPoint(-0.7F, -0.5F, 0.2F);
        this.WingboneR.addBox(0.0F, -0.1F, -0.5F, 6, 1, 1, 0.0F);
        this.setRotateAngle(WingboneR, 0.0F, 2.356194490192345F, 0.0F);
        this.WingboneL_2 = new ModelRenderer(this, 55, 86);
        this.WingboneL_2.setRotationPoint(33.0F, -0.1F, 0.0F);
        this.WingboneL_2.addBox(0.0F, 0.0F, 0.0F, 14, 1, 1, 0.0F);
        this.setRotateAngle(WingboneL_2, 0.0F, -0.460766922526503F, 0.0F);
