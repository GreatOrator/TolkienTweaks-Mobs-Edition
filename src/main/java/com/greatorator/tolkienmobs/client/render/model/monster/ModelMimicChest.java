...
public class ModelMimicChest extends ModelTTM {
    ...
    public ModelRenderer MimiEyePart_4;
    public ModelRenderer MimiEyePart_5;
    public ModelRenderer MimiEyePart_6;
    public ModelRenderer MimiEyePart_7;
    public ModelRenderer MimiEyePart_8;
    ...
    public ModelMimicChest()
    {
        ...
        this.MimiEyePart_2 = new ModelRenderer(this, 54, 7);
        this.MimiEyePart_2.setRotationPoint(0.5F, -1.0F, 0.5F);
        this.MimiEyePart_2.addBox(-2.5F, -1.0F, -2.5F, 4, 1, 4, 0.0F);
        this.setRotateAngle(MimiEyePart_2, 0.0F, 0.0F, 0.015707963267948967F);
        ...
        this.MimiEyePart_1 = new ModelRenderer(this, 52, 1);
        this.MimiEyePart_1.setRotationPoint(0.0F, -0.5F, 0.0F);
        this.MimiEyePart_1.addBox(-2.5F, -1.0F, -2.5F, 5, 1, 5, 0.0F);
        this.setRotateAngle(MimiEyePart_1, 0.0F, 0.0F, 0.015707963267948967F);
        this.MimiEyePart_6 = new ModelRenderer(this, 52, 1);
        this.MimiEyePart_6.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart_6.addBox(-2.5F, -1.0F, -2.5F, 5, 1, 5, 0.0F);
        this.setRotateAngle(MimiEyePart_6, 0.0F, 0.39269908169872414F, 0.015707963267948967F);
        ...
        this.MimiEyePart_8 = new ModelRenderer(this, 54, 12);
        this.MimiEyePart_8.setRotationPoint(1.0F, -0.1F, 1.0F);
        this.MimiEyePart_8.addBox(-2.5F, -1.0F, -2.5F, 2, 1, 2, 0.0F);
        this.setRotateAngle(MimiEyePart_8, 0.0F, 0.0F, 0.015707963267948967F);
        ...
        this.MimiEyePart_7 = new ModelRenderer(this, 52, 1);
        this.MimiEyePart_7.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart_7.addBox(-2.5F, -1.0F, -2.5F, 5, 1, 5, 0.0F);
        this.setRotateAngle(MimiEyePart_7, 0.0F, 0.7853981633974483F, 0.015707963267948967F);
        ...
        this.MimiEyePart_4 = new ModelRenderer(this, 50, 0);
        this.MimiEyePart_4.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart_4.addBox(-3.0F, -1.0F, -3.0F, 6, 1, 6, 0.0F);
        this.setRotateAngle(MimiEyePart_4, 0.0F, 0.7853981633974483F, 0.015707963267948967F);
        ...
        this.MimiEyePart_3 = new ModelRenderer(this, 50, 0);
        this.MimiEyePart_3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart_3.addBox(-3.0F, -1.0F, -3.0F, 6, 1, 6, 0.0F);
        this.setRotateAngle(MimiEyePart_3, 0.0F, 0.39269908169872414F, 0.015707963267948967F);
        ...
        this.MimiEyePart = new ModelRenderer(this, 50, 0);
        this.MimiEyePart.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart.addBox(-3.0F, -1.0F, -3.0F, 6, 1, 6, 0.0F);
        this.setRotateAngle(MimiEyePart, 0.0F, 0.7853981633974483F, 0.015707963267948967F);
        ...
        this.MimiEyePart_5 = new ModelRenderer(this, 52, 1);
        this.MimiEyePart_5.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.MimiEyePart_5.addBox(-2.5F, -1.0F, -2.5F, 5, 1, 5, 0.0F);
        this.setRotateAngle(MimiEyePart_5, 0.0F, 0.7853981633974483F, 0.015707963267948967F);
        ...
        this.MimicEye.addChild(this.MimiEyePart_2);
        this.box.addChild(this.MimicTeeth);
        this.MimicEye.addChild(this.MimiEyePart_1);
        this.MimiEyePart_5.addChild(this.MimiEyePart_6);
        this.MimiEyePart_2.addChild(this.MimiEyePart_8);
        ...
        this.MimiEyePart_6.addChild(this.MimiEyePart_7);
        this.boxLid.addChild(this.MimicGums_6);
        this.MimiEyePart_3.addChild(this.MimiEyePart_4);
        this.boxLid.addChild(this.MimicTeeth_1);
        this.MimiEyePart.addChild(this.MimiEyePart_3);
        ...
        this.MimiEyePart_1.addChild(this.MimiEyePart_5);
