...
public class RenderToaddle extends RenderLiving<EntityToaddle> {
    ...
    @Override
    @Nonnull
    protected ResourceLocation getEntityTexture(@Nonnull EntityToaddle entity) {
    ...
    public static class Factory implements IRenderFactory<EntityToaddle> {

        @Override
        public Render<? super EntityToaddle> createRenderFor(RenderManager manager) {
    ...
    @Override
    protected void preRenderCallback(EntityToaddle entitylivingbaseIn, float partialTickTime) {
