...
public class LayerMithrilGolemFlower implements LayerRenderer<EntityTMMithrilGolem>
{
    ...
    public void doRenderLayer(EntityTMMithrilGolem entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
