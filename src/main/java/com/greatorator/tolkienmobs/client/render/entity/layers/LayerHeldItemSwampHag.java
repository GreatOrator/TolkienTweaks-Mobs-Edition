...
//public class LayerHeldItemSwampHag implements LayerRenderer<EntityTMSwampHag>
//{
//    private final RenderSwampHag witchRenderer;
//
//    public LayerHeldItemSwampHag(RenderSwampHag witchRendererIn)
//    {
//        this.witchRenderer = witchRendererIn;
//    }
//
//    public void doRenderLayer(EntityTMSwampHag LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
//    {
...
//            minecraft.getItemRenderer().renderItem(LivingEntityIn, itemstack, ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND);
