...
public class LayerHeldItemSwampHag implements LayerRenderer<EntityTMSwampHag>
{
    ...
    public void doRenderLayer(EntityTMSwampHag entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
