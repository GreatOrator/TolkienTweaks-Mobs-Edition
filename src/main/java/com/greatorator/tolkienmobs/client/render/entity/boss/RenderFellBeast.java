...
//    private static final ResourceLocation FELLBEAST_TEXTURES = new ResourceLocation(TolkienMobs.MODID + ":textures/entity/fellbeast/fellbeast.png");
//
//    public RenderFellBeast(RenderManager renderManagerIn)
//    {
//        super(renderManagerIn, new ModelFellBeast(0.0F), 0.5F);
//        this.addLayer(new LayerFellBeastEyes(this));
...
//    }
//
//    protected void renderModel(EntityTMFellBeast LivingEntityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
//    {
//        if (LivingEntityIn.deathTicks > 0)
//        {
//            float f6 = (float)LivingEntityIn.deathTicks / 200.0F;
//            GL11.glDepthFunc(GL11.GL_LEQUAL);
//            GL11.glEnable(GL11.GL_ALPHA_TEST);
//            GL11.glAlphaFunc(GL11.GL_GREATER, f6);
//            this.bindTexture(FELLBEAST_EXPLODING_TEXTURES);
//            this.mainModel.render(LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
//            GL11.glAlphaFunc(GL11.GL_GREATER, 0.1F);
//            GL11.glDepthFunc(GL11.GL_EQUAL);
//        }
//
//        this.bindEntityTexture(LivingEntityIn);
//        this.mainModel.render(LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
//
//        if (LivingEntityIn.hurtTime > 0)
//        {
//            GL11.glDepthFunc(GL11.GL_EQUAL);
...
//        {
//            this.bindTexture(FELLBEASTCRYSTAL_BEAM_TEXTURES);
