...
public class ModelFellBeast extends ModelBase {
    ...
    /** The jaw Model renderer of the fell beast */
    private final ModelRenderer jaw;
    /** The body Model renderer of the fell beast */
    private final ModelRenderer body;
    /** The rear leg Model renderer of the fell beast */
    private final ModelRenderer rearLeg;
    /** The rear leg tip Model renderer of the fell beast */
    private final ModelRenderer rearLegTip;
    /** The rear foot Model renderer of the fell beast */
    private final ModelRenderer rearFoot;
    /** The wing Model renderer of the fell beast */
    private final ModelRenderer wing;
    /** The wing tip Model renderer of the fell beast */
    private final ModelRenderer wingTip;
    private float partialTicks;

    public ModelFellBeast(float p_i46360_1_)
    {
        ...
        this.setTextureOffset("head.upperlip", 169, 144);
        ...
        this.head.addBox("upperlip", -6.0F, -1.0F, -24.0F, 12, 9, 16);
