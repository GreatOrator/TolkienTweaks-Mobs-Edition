...
//    }
    ...
    public static String[] comment = {"You shall not pass!", "I See you!", "Oh Sh** what was it this time!?!?", "WHAT DID YOU DO!?!?!?!.. Oh never mind that was me...", "HA! You thought you were going to play minecraft today? NO! You get to play \"Decode the Crash Report\" ", "Hmm. That was unexpected..."};
    ...
    public static void fatalErrorMessage(String error) {
        ...
        error("Please go here for assistance: https://github.com/GreatOrator/TolkienTweaks-Mobs/issues");
        error("You can also try the Fellowship server on Discord");
        error("*************************************************************************************");
    }
