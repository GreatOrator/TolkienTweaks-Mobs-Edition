...
import com.greatorator.tolkienmobs.entity.EntityTreeEntRender;
...
public class TolkienMobsEntities {
    ...
    public static void initModels() {
        RenderingRegistry.registerEntityRenderingHandler(EntityTreeEnt.class, EntityTreeEntRender.FACTORY);
    }
}
