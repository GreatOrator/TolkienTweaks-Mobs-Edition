...
public class TolkienContainers {
    ...
    public static MenuType<ContainerBCTile<TrinketTableTile>> TRINKETTABLE_CONTAINER;
    ...
    public static void registerContainers(RegistryEvent.Register<MenuType<?>> event) {
        ...
        event.getRegistry().register(TRINKETTABLE_CONTAINER = (MenuType<ContainerBCTile<TrinketTableTile>>) IForgeMenuType.create((id, playerInv, extraData) -> new ContainerBCTile<>(TRINKETTABLE_CONTAINER, id, playerInv, extraData, TrinketTableTile.SLOT_LAYOUT)).setRegistryName("trinket_table_container"));
