...
//    public static final Enchantment HOBBIT_PLOW = new EnchantmentHobbitPlow(Enchantment.Rarity.RARE, EnumEnchantmentType.DIGGER);
...
//        initEnchantments(HOBBIT_PLOW,"tolkienmobs.hobbit_plow",TolkienMobs.MODID + ":hobbit_plow");
