...
import com.greatorator.tolkienmobs.block.BaseBlock;
...
import com.greatorator.tolkienmobs.handler.enums.TolkienTier;
import com.greatorator.tolkienmobs.handler.registers.FoodRegister;
...
import com.greatorator.tolkienmobs.item.basic.*;
...
public class TolkienItems {
    ...
    public static RegistryObject<Item> WALL_MITHRIL_ITEM = ITEMS.register("wall_mithril", () -> new ItemBlockBCore(WALL_MITHRIL.get(), new Item.Properties().tab(decoGroup)));
    ...
    public static RegistryObject<Item> WALL_MORGULIRON_ITEM = ITEMS.register("wall_morguliron", () -> new ItemBlockBCore(WALL_MORGULIRON.get(), new Item.Properties().tab(decoGroup)));
    ...
    public static RegistryObject<Item> ITEM_PLACARD = ITEMS.register("item_placard", () -> new BaseBlock(TolkienBlocks.PLACARD.get(), (new Item.Properties()).stacksTo(1).tab(decoGroup)).setHasLore());
    ...
    public static RegistryObject<Item> SLEEPING_BAG_RED_ITEM = ITEMS.register("sleeping_bag_red", () -> new BaseBlock(SLEEPING_BAG_RED.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_BLACK_ITEM = ITEMS.register("sleeping_bag_black", () -> new BaseBlock(SLEEPING_BAG_BLACK.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_BROWN_ITEM = ITEMS.register("sleeping_bag_brown", () -> new BaseBlock(SLEEPING_BAG_BROWN.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_CYAN_ITEM = ITEMS.register("sleeping_bag_cyan", () -> new BaseBlock(SLEEPING_BAG_CYAN.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_GRAY_ITEM = ITEMS.register("sleeping_bag_gray", () -> new BaseBlock(SLEEPING_BAG_GRAY.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_GREEN_ITEM = ITEMS.register("sleeping_bag_green", () -> new BaseBlock(SLEEPING_BAG_GREEN.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_LIGHT_BLUE_ITEM = ITEMS.register("sleeping_bag_light_blue", () -> new BaseBlock(SLEEPING_BAG_LIGHT_BLUE.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_LIGHT_GRAY_ITEM = ITEMS.register("sleeping_bag_light_gray", () -> new BaseBlock(SLEEPING_BAG_LIGHT_GRAY.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_LIME_ITEM = ITEMS.register("sleeping_bag_lime", () -> new BaseBlock(SLEEPING_BAG_LIME.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_MAGENTA_ITEM = ITEMS.register("sleeping_bag_magenta", () -> new BaseBlock(SLEEPING_BAG_MAGENTA.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_ORANGE_ITEM = ITEMS.register("sleeping_bag_orange", () -> new BaseBlock(SLEEPING_BAG_ORANGE.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_PINK_ITEM = ITEMS.register("sleeping_bag_pink", () -> new BaseBlock(SLEEPING_BAG_PINK.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_PURPLE_ITEM = ITEMS.register("sleeping_bag_purple", () -> new BaseBlock(SLEEPING_BAG_PURPLE.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_WHITE_ITEM = ITEMS.register("sleeping_bag_white", () -> new BaseBlock(SLEEPING_BAG_WHITE.get(), new Item.Properties().tab(decoGroup)).setHasLore());
    public static RegistryObject<Item> SLEEPING_BAG_YELLOW_ITEM = ITEMS.register("sleeping_bag_yellow", () -> new BaseBlock(SLEEPING_BAG_YELLOW.get(), new Item.Properties().tab(decoGroup)).setHasLore());

    // Quest
    public static RegistryObject<Item> ITEM_BERYL = ITEMS.register("item_beryl", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_FORTRESSMAP = ITEMS.register("item_fortressmap", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WATCHERHEART = ITEMS.register("item_watcherheart", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_WATCHERHEART_CRACKED = ITEMS.register("item_watcherheart_cracked", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_KEYSTONE = ITEMS.register("item_keystone", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_DARKSADDLE = ITEMS.register("item_darksaddle", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_ARTIFACT = ITEMS.register("item_artifact", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_BLANKPAPER = ITEMS.register("item_blankpaper", () -> new BaseItem(new Item.Properties().stacksTo(12).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYARMOR = ITEMS.register("item_fancyarmor", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_FANCYCLOTH = ITEMS.register("item_fancycloth", () -> new BaseItem(new Item.Properties().stacksTo(3).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYHAMMER = ITEMS.register("item_fancyhammer", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_FANCYHELM = ITEMS.register("item_fancyhelm", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYKEY = ITEMS.register("item_fancykey", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYPICK = ITEMS.register("item_fancypick", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYSHIELD = ITEMS.register("item_fancyshield", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYSHIELD2 = ITEMS.register("item_fancyshield2", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_FANCYSWORD = ITEMS.register("item_fancysword", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FANCYSWORD2 = ITEMS.register("item_fancysword2", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_LETTER = ITEMS.register("item_letter", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_SCROLL = ITEMS.register("item_scroll", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_SCROLL2 = ITEMS.register("item_scroll2", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_SPECIALFLOWER = ITEMS.register("item_specialflower", () -> new BaseItem(new Item.Properties().stacksTo(12).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_STORYBOOK = ITEMS.register("item_storybook", () -> new BaseItem(new Item.Properties().stacksTo(12).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_STORYBOOK2 = ITEMS.register("item_storybook2", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_STORYBOOK3 = ITEMS.register("item_storybook3", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_STORYBOOK4 = ITEMS.register("item_storybook4", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNARMOR = ITEMS.register("item_wornarmor", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNHELM = ITEMS.register("item_wornhelm", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNKEY = ITEMS.register("item_wornkey", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNPICK = ITEMS.register("item_wornpick", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNSHIELD = ITEMS.register("item_wornshield", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNSHIELD2 = ITEMS.register("item_wornshield2", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WORNSWORD = ITEMS.register("item_wornsword", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WOVENBASKET = ITEMS.register("item_wovenbasket", () -> new BaseItem(new Item.Properties().stacksTo(3).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WRITTENPAPER = ITEMS.register("item_writtenpaper", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_PUNGENTHERB = ITEMS.register("item_pungentherb", () -> new BaseItem(new Item.Properties().stacksTo(3).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_LOCKPICK = ITEMS.register("item_lockpick", () -> new BaseItem(new Item.Properties().stacksTo(16).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BROKENSWORD = ITEMS.register("item_brokensword", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_REFORGEDSWORD = ITEMS.register("item_reforgedsword", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_MAGIC_CLOTH = ITEMS.register("item_magic_cloth", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    public static RegistryObject<Item> ITEM_KEYFRAGMENT = ITEMS.register("item_keyfragment", () -> new BaseItem(new Item.Properties().stacksTo(2).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_OILYKEY = ITEMS.register("item_oilykey", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_MITHRILNUGGET = ITEMS.register("item_mithrilnugget", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setEffectOverride().setHasLore());
    ...
    // Backpack Upgrades
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_BASE = ITEMS.register("upgrade_item_backpack_upgrade_base", () -> new BaseItem(new Item.Properties().stacksTo(5).tab(matsGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_SIZE = ITEMS.register("item_backpack_upgrade_size", () -> new BaseItem(new Item.Properties().stacksTo(2).tab(matsGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_FLUID = ITEMS.register("item_backpack_upgrade_fluid", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(matsGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_CRAFTING = ITEMS.register("item_backpack_upgrade_crafting", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(matsGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_SLEEPING = ITEMS.register("item_backpack_upgrade_sleeping", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(matsGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_BACKPACK_UPGRADE_CAMPFIRE = ITEMS.register("item_backpack_upgrade_campfire", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(matsGroup)).setHasLore());
    ...
    public static RegistryObject<Item> GEM_AMMOLITE = ITEMS.register("gem_ammolite", () -> new BaseItem(new Item.Properties().stacksTo(16).tab(matsGroup)).setEffectOverride());
    ...
    public static RegistryObject<AxeItem> AXE_MITHRIL = ITEMS.register("axe_mithril", () -> new AxeItem(TolkienTier.MITHRIL, 8.0F, -1.5F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<HoeItem> HOE_MITHRIL = ITEMS.register("hoe_mithril", () -> new HoeItem(TolkienTier.MITHRIL, 1, 0.8F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<PickaxeItem> PICKAXE_MITHRIL = ITEMS.register("pickaxe_mithril", () -> new PickaxeItem(TolkienTier.MITHRIL, 1, -1.0F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<ShovelItem> SHOVEL_MITHRIL = ITEMS.register("shovel_mithril", () -> new ShovelItem(TolkienTier.MITHRIL, 2.8F, -1.0F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<SwordItem> SWORD_MITHRIL = ITEMS.register("sword_mithril", () -> new SwordItem(TolkienTier.MITHRIL, 7, -1.0F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<AxeItem> AXE_MORGULIRON = ITEMS.register("axe_morguliron", () -> new AxeItem(TolkienTier.MORGULIRON, 8.0F, -1.5F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<HoeItem> HOE_MORGULIRON = ITEMS.register("hoe_morguliron", () -> new HoeItem(TolkienTier.MORGULIRON, 1, 0.8F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<PickaxeItem> PICKAXE_MORGULIRON = ITEMS.register("pickaxe_morguliron", () -> new PickaxeItem(TolkienTier.MORGULIRON, 1, -1.5F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<ShovelItem> SHOVEL_MORGULIRON = ITEMS.register("shovel_morguliron", () -> new ShovelItem(TolkienTier.MORGULIRON, 2.8F, -1.5F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<SwordItem> SWORD_MORGULIRON = ITEMS.register("sword_morguliron", () -> new SwordItem(TolkienTier.MORGULIRON, 8, -2.3F, (new Item.Properties()).tab(toolsGroup)));
    public static RegistryObject<SwordItem> SWORD_WITCHKING = ITEMS.register("sword_witchking", () -> new BaseSwordItem(TolkienTier.MORGULIRON, 9, -0.5F, (new Item.Properties()).tab(toolsGroup)).setEffectOverride());
    public static RegistryObject<SwordItem> SWORD_URUK = ITEMS.register("sword_uruk", () -> new BaseSwordItem(TolkienTier.MORGULIRON, 11, -0.5F, (new Item.Properties()).tab(toolsGroup)).setEffectOverride());
    public static RegistryObject<SwordItem> WHIP_FIRE = ITEMS.register("whip_fire", () -> new BaseSwordItem(TolkienTier.MORGULIRON, 15, -0.5F, (new Item.Properties()).tab(toolsGroup)).setEffectOverride());
    public static RegistryObject<SwordItem> CLUB_WOODEN = ITEMS.register("club_wooden", () -> new BaseSwordItem(TolkienTier.MORGULIRON, 9, -0.5F, (new Item.Properties()).tab(toolsGroup)).setEffectOverride());
    ...
    // Coins & Tokens
    public static RegistryObject<Item> ITEM_COIN_BRONZE = ITEMS.register("item_coin_bronze", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_COIN_SILVER = ITEMS.register("item_coin_silver", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_COIN_GOLD = ITEMS.register("item_coin_gold", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_COIN_MITHRIL = ITEMS.register("item_coin_mithril", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_DARKSIGIL = ITEMS.register("item_darksigil", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FACTIONCOIN = ITEMS.register("item_coin1", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_FACTIONTOKEN = ITEMS.register("item_coin2", () -> new BaseItem(new Item.Properties().tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_CAVECOMPLETE = ITEMS.register("item_cavecomplete", () -> new BaseItem(new Item.Properties().stacksTo(3).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_WATCHERCOMPLETE = ITEMS.register("item_watchercomplete", () -> new BaseItem(new Item.Properties().stacksTo(3).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_TOKEN_EASTERN_ALLIANCE = ITEMS.register("item_token_eastern_alliance", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    public static RegistryObject<Item> ITEM_TOKEN_WESTERN_ALLIANCE = ITEMS.register("item_token_western_alliance", () -> new BaseItem(new Item.Properties().stacksTo(1).tab(questGroup)).setHasLore());
    ...
    public static RegistryObject<Item> GOLEM_STONE_SUMMON = ITEMS.register("item_golem_stone_summon", () -> new BaseItem(new Item.Properties().stacksTo(16).tab(spawnGroup)).setEffectOverride().setHasLore().setItemHasUse().setSpawnInfo());

    // Music Discs
    public static RegistryObject<Item> RECORD_RIVENDELL = ITEMS.register("record_rivendell", () -> new BaseRecordItem(1, ridersofrivendell, (new Item.Properties()).stacksTo(1).tab(questGroup)));
    ...
    public static RegistryObject<Item> MIRUVOR = ITEMS.register("drink_miruvor", () -> new BaseFoodItem(new Item.Properties().tab(foodGroup).stacksTo(16).food(FoodRegister.MIRUVOR)).setEffectOverride().setItemUseAction(true));
    public static RegistryObject<Item> GROG = ITEMS.register("drink_grog", () -> new BaseFoodItem(new Item.Properties().tab(foodGroup).stacksTo(16).food(FoodRegister.GROG)).setEffectOverride().setItemUseAction(true));

    // Foods
    public static RegistryObject<Item> LEMBAS = ITEMS.register("food_lembas", () -> new BaseFoodItem(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.LEMBAS)).setEffectOverride());
    public static RegistryObject<Item> HONEY_CAKE = ITEMS.register("food_honeycake", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.HONEY_CAKE)));
    public static RegistryObject<Item> CRAM = ITEMS.register("food_cram", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.CRAM)));
    public static RegistryObject<Item> MONSTER_FLESH = ITEMS.register("monster_flesh", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.MONSTER_FLESH)));
    public static RegistryObject<Item> INSECT = ITEMS.register("food_insect", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.INSECT)));
    public static RegistryObject<Item> GOLDEN_INSECT = ITEMS.register("food_golden_insect", () -> new BaseFoodItem(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.GOLDEN_INSECT)).setEffectOverride());
    public static RegistryObject<Item> TREE_ACORN = ITEMS.register("food_tree_acorn", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.TREE_ACORN)));
    public static RegistryObject<Item> GOLDEN_TREE_ACORN = ITEMS.register("food_golden_tree_acorn", () -> new BaseFoodItem(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.GOLDEN_TREE_ACORN)).setEffectOverride());
    public static RegistryObject<Item> FOOD_HONEY = ITEMS.register("food_honey", () -> new Item(new Item.Properties().tab(foodGroup).stacksTo(64).food(FoodRegister.FOOD_HONEY)));
